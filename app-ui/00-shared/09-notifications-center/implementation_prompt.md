# Implementation prompt — `00-shared/09-notifications-center`
...
| Kind | Screen (`list`) |
| Module | `00-shared` |
| Screen slug | `09-notifications-center` |
| Chronology | `S-009` |
| Slice | `VS-00` |
| Phase | `shared` |
| Deferred | `false` |
| Chronology status | `not-started` |
| Route | `/00-shared/09-notifications-center` |
| Parent route | `/00-shared/09-notifications-center` |
...
| Localization prefix | `00_shared.09_notifications_center` |
...
Folder: `app-ui/00-shared/09-notifications-center/`
...
| Page | `frontend/lib/features/shared/presentation/pages/09_notifications_center_page.dart` |
...
| Router entry | `frontend/lib/app/router/` (route must equal `/00-shared/09-notifications-center`) |
...
8. Register route `/00-shared/09-notifications-center` with the access guard for roles `authenticated-user`.
...
11. Add ARB keys under `00_shared.09_notifications_center` only — no hard-coded user strings.
