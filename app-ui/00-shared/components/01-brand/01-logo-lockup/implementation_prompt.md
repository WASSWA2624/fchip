# Implementation prompt — shared component `01-brand/01-logo-lockup`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Logo lockup** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Logo left · FCHIP right · slogan under FCHIP (space-aware)_
...
| Category | `01-brand` |
| Slug | `01-logo-lockup` |
| Suggested Dart name | `App01LogoLockup` |
| Used by | `all shells`, `splash`, `login` |
| Breakpoints | `mobile`, `tablet`, `desktop` |
| Themes | `light`, `dark`, `system` |

## Visual sources

Folder: `app-ui/00-shared/components/01-brand/01-logo-lockup/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/01-brand/app_01_logo_lockup.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/01-brand/app_01_logo_lockup_test.dart` |
...
4. Implement `App01LogoLockup` with:
