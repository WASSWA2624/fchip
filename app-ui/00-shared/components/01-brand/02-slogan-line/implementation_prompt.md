# Implementation prompt — shared component `01-brand/02-slogan-line`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Slogan line** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Your health, our mission._
...
| Category | `01-brand` |
| Slug | `02-slogan-line` |
| Suggested Dart name | `App02SloganLine` |
| Used by | `top app bar`, `auth`, `cover` |
| Breakpoints | `mobile`, `tablet`, `desktop` |
| Themes | `light`, `dark`, `system` |

## Visual sources

Folder: `app-ui/00-shared/components/01-brand/02-slogan-line/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/01-brand/app_02_slogan_line.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/01-brand/app_02_slogan_line_test.dart` |
...
4. Implement `App02SloganLine` with:
