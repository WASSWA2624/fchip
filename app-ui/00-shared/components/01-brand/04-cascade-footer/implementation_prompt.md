# Implementation prompt — shared component `01-brand/04-cascade-footer`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Cascade footer** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Cascade Data & Feedback cue_
...
| Category | `01-brand` |
| Slug | `04-cascade-footer` |
| Suggested Dart name | `App04CascadeFooter` |
| Used by | `desktop side nav` |
| Breakpoints | `mobile`, `tablet`, `desktop` |
| Themes | `light`, `dark`, `system` |

## Visual sources

Folder: `app-ui/00-shared/components/01-brand/04-cascade-footer/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/01-brand/app_04_cascade_footer.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/01-brand/app_04_cascade_footer_test.dart` |
...
4. Implement `App04CascadeFooter` with:
