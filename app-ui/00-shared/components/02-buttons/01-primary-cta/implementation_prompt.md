# Implementation prompt — shared component `02-buttons/01-primary-cta`
...
| Category | `02-buttons` |
| Slug | `01-primary-cta` |
| Suggested Dart name | `App01PrimaryCta` |
...
Folder: `app-ui/00-shared/components/02-buttons/01-primary-cta/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/02-buttons/app_01_primary_cta.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/02-buttons/app_01_primary_cta_test.dart` |
...
4. Implement `App01PrimaryCta` with:
