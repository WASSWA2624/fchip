# Implementation prompt — shared component `02-buttons/03-danger-cta`
...
| Category | `02-buttons` |
| Slug | `03-danger-cta` |
| Suggested Dart name | `App03DangerCta` |
...
Folder: `app-ui/00-shared/components/02-buttons/03-danger-cta/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/02-buttons/app_03_danger_cta.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/02-buttons/app_03_danger_cta_test.dart` |
...
4. Implement `App03DangerCta` with:
