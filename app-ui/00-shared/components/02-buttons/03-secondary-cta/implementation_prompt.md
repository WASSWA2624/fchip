# Implementation prompt — shared component `02-buttons/03-secondary-cta`
...
| Category | `02-buttons` |
| Slug | `03-secondary-cta` |
| Suggested Dart name | `App03SecondaryCta` |
...
Folder: `app-ui/00-shared/components/02-buttons/03-secondary-cta/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/02-buttons/app_03_secondary_cta.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/02-buttons/app_03_secondary_cta_test.dart` |
...
4. Implement `App03SecondaryCta` with:
