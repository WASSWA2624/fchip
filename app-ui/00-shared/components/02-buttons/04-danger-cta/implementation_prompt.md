# Implementation prompt — shared component `02-buttons/04-danger-cta`
...
| Category | `02-buttons` |
| Slug | `04-danger-cta` |
| Suggested Dart name | `App04DangerCta` |
...
Folder: `app-ui/00-shared/components/02-buttons/04-danger-cta/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/02-buttons/app_04_danger_cta.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/02-buttons/app_04_danger_cta_test.dart` |
...
4. Implement `App04DangerCta` with:
