# Implementation prompt — shared component `02-buttons/04-text-link`
...
| Category | `02-buttons` |
| Slug | `04-text-link` |
| Suggested Dart name | `App04TextLink` |
| Used by | `lists`, `auth` |
...
Folder: `app-ui/00-shared/components/02-buttons/04-text-link/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/02-buttons/app_04_text_link.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/02-buttons/app_04_text_link_test.dart` |
...
4. Implement `App04TextLink` with:
