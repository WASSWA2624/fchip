# Implementation prompt — shared component `03-chips/03-offline-ready-chip`
...
| Category | `03-chips` |
| Slug | `03-offline-ready-chip` |
| Suggested Dart name | `App03OfflineReadyChip` |
| Used by | `CHW`, `feeders` |
...
Folder: `app-ui/00-shared/components/03-chips/03-offline-ready-chip/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/03-chips/app_03_offline_ready_chip.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/03-chips/app_03_offline_ready_chip_test.dart` |
| Goldens | `frontend/test/shared/components/03-chips/goldens/` |
...
4. Implement `App03OfflineReadyChip` with:
