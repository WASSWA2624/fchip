# Implementation prompt — shared component `03-chips/04-risk-chip`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Risk chip** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: High / elevated risk flag_
...
| Category | `03-chips` |
| Slug | `04-risk-chip` |
| Suggested Dart name | `App04RiskChip` |
| Used by | `alerts`, `facility` |
| Breakpoints | `mobile`, `tablet`, `desktop` |
| Themes | `light`, `dark`, `system` |

## Visual sources

Folder: `app-ui/00-shared/components/03-chips/04-risk-chip/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/03-chips/app_04_risk_chip.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/03-chips/app_04_risk_chip_test.dart` |
...
4. Implement `App04RiskChip` with:
