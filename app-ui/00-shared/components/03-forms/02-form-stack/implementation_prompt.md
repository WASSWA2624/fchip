# Implementation prompt — shared component `03-forms/02-form-stack`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Form stack** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Vertical stack of labeled fields_
...
| Category | `03-forms` |
| Slug | `02-form-stack` |
| Suggested Dart name | `App02FormStack` |
| Used by | `visit`, `referral`, `feeder entry` |
| Breakpoints | `mobile`, `tablet`, `desktop` |
| Themes | `light`, `dark`, `system` |

## Visual sources

Folder: `app-ui/00-shared/components/03-forms/02-form-stack/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/03-forms/app_02_form_stack.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/03-forms/app_02_form_stack_test.dart` |
...
4. Implement `App02FormStack` with:
