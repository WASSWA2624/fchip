# Implementation prompt — shared component `03-forms/03-consent-toggle`
...
Folder: `app-ui/00-shared/components/03-forms/03-consent-toggle/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/03-forms/app_03_consent_toggle.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/03-forms/app_03_consent_toggle_test.dart` |
