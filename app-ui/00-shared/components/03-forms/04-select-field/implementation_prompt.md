# Implementation prompt — shared component `03-forms/04-select-field`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Select field** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Single-choice shell_
...
| Category | `03-forms` |
| Slug | `04-select-field` |
| Suggested Dart name | `App04SelectField` |
| Used by | `urgency`, `facility picker` |
| Breakpoints | `mobile`, `tablet`, `desktop` |
| Themes | `light`, `dark`, `system` |

## Visual sources

Folder: `app-ui/00-shared/components/03-forms/04-select-field/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/03-forms/app_04_select_field.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/03-forms/app_04_select_field_test.dart` |
...
4. Implement `App04SelectField` with:
