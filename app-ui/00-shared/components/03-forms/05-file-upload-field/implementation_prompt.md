# Implementation prompt — shared component `03-forms/05-file-upload-field`
...
| Category | `03-forms` |
| Slug | `05-file-upload-field` |
| Suggested Dart name | `App05FileUploadField` |
...
Folder: `app-ui/00-shared/components/03-forms/05-file-upload-field/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/03-forms/app_05_file_upload_field.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/03-forms/app_05_file_upload_field_test.dart` |
| Goldens | `frontend/test/shared/components/03-forms/goldens/` |
...
4. Implement `App05FileUploadField` with:
