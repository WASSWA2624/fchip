# Implementation prompt — shared component `04-cards/01-stat-card`
...
| Category | `04-cards` |
| Slug | `01-stat-card` |
| Suggested Dart name | `App01StatCard` |
| Used by | `dashboards` |
...
Folder: `app-ui/00-shared/components/04-cards/01-stat-card/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/04-cards/app_01_stat_card.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/04-cards/app_01_stat_card_test.dart` |
...
4. Implement `App01StatCard` with:
