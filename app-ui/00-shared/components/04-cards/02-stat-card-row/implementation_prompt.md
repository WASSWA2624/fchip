# Implementation prompt — shared component `04-cards/02-stat-card-row`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Stat card row** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: 2–4 metrics in a row_
...
| Category | `04-cards` |
| Slug | `02-stat-card-row` |
| Suggested Dart name | `App02StatCardRow` |
| Used by | `dashboards`, `feeder homes` |
| Breakpoints | `mobile`, `tablet`, `desktop` |
| Themes | `light`, `dark`, `system` |

## Visual sources

Folder: `app-ui/00-shared/components/04-cards/02-stat-card-row/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/04-cards/app_02_stat_card_row.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/04-cards/app_02_stat_card_row_test.dart` |
...
4. Implement `App02StatCardRow` with:
