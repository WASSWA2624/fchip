# Implementation prompt — shared component `04-cards/03-list-row-card`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **List row card** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Tappable title + subtitle row_
...
| Category | `04-cards` |
| Slug | `03-list-row-card` |
| Suggested Dart name | `App03ListRowCard` |
| Used by | `worklists`, `inboxes` |
| Breakpoints | `mobile`, `tablet`, `desktop` |
| Themes | `light`, `dark`, `system` |

## Visual sources

Folder: `app-ui/00-shared/components/04-cards/03-list-row-card/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/04-cards/app_03_list_row_card.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/04-cards/app_03_list_row_card_test.dart` |
...
4. Implement `App03ListRowCard` with:
