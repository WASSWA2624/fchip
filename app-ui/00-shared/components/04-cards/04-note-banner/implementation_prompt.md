# Implementation prompt — shared component `04-cards/04-note-banner`
...
Folder: `app-ui/00-shared/components/04-cards/04-note-banner/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/04-cards/app_04_note_banner.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/04-cards/app_04_note_banner_test.dart` |
