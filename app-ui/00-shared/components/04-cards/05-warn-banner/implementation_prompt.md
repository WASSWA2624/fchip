# Implementation prompt — shared component `04-cards/05-warn-banner`
...
| Category | `04-cards` |
| Slug | `05-warn-banner` |
| Suggested Dart name | `App05WarnBanner` |
...
Folder: `app-ui/00-shared/components/04-cards/05-warn-banner/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/04-cards/app_05_warn_banner.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/04-cards/app_05_warn_banner_test.dart` |
...
4. Implement `App05WarnBanner` with:
