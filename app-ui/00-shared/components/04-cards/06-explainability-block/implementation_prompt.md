# Implementation prompt — shared component `04-cards/06-explainability-block`
...
| Category | `04-cards` |
| Slug | `06-explainability-block` |
| Suggested Dart name | `App06ExplainabilityBlock` |
...
Folder: `app-ui/00-shared/components/04-cards/06-explainability-block/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/04-cards/app_06_explainability_block.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/04-cards/app_06_explainability_block_test.dart` |
| Goldens | `frontend/test/shared/components/04-cards/goldens/` |
...
4. Implement `App06ExplainabilityBlock` with:
