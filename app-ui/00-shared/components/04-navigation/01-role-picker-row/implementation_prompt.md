# Implementation prompt — shared component `04-navigation/01-role-picker-row`
...
| Slug | `01-role-picker-row` |
| Suggested Dart name | `App01RolePickerRow` |
...
Folder: `app-ui/00-shared/components/04-navigation/01-role-picker-row/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/04-navigation/app_01_role_picker_row.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/04-navigation/app_01_role_picker_row_test.dart` |
...
4. Implement `App01RolePickerRow` with:
