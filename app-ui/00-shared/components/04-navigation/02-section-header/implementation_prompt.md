# Implementation prompt — shared component `04-navigation/02-section-header`
...
| Slug | `02-section-header` |
| Suggested Dart name | `App02SectionHeader` |
...
Folder: `app-ui/00-shared/components/04-navigation/02-section-header/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/04-navigation/app_02_section_header.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/04-navigation/app_02_section_header_test.dart` |
...
4. Implement `App02SectionHeader` with:
