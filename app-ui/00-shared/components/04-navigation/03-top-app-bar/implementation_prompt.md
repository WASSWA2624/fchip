# Implementation prompt — shared component `04-navigation/03-top-app-bar`
...
_Purpose: Brand lockup (logo · FCHIP · slogan by space)_
...
| Slug | `03-top-app-bar` |
| Suggested Dart name | `App03TopAppBar` |
...
Folder: `app-ui/00-shared/components/04-navigation/03-top-app-bar/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/04-navigation/app_03_top_app_bar.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/04-navigation/app_03_top_app_bar_test.dart` |
...
4. Implement `App03TopAppBar` with:
