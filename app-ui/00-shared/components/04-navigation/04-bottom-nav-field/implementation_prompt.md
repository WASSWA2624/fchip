# Implementation prompt — shared component `04-navigation/04-bottom-nav-field`
...
| Slug | `04-bottom-nav-field` |
| Suggested Dart name | `App04BottomNavField` |
| Used by | `01` |
...
Folder: `app-ui/00-shared/components/04-navigation/04-bottom-nav-field/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/04-navigation/app_04_bottom_nav_field.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/04-navigation/app_04_bottom_nav_field_test.dart` |
...
4. Implement `App04BottomNavField` with:
