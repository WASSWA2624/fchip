# Implementation prompt — shared component `04-navigation/05-side-nav-desktop`
...
| Slug | `05-side-nav-desktop` |
| Suggested Dart name | `App05SideNavDesktop` |
...
Folder: `app-ui/00-shared/components/04-navigation/05-side-nav-desktop/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/04-navigation/app_05_side_nav_desktop.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/04-navigation/app_05_side_nav_desktop_test.dart` |
| Goldens | `frontend/test/shared/components/04-navigation/goldens/` |
...
4. Implement `App05SideNavDesktop` with:
