# Implementation prompt — shared component `04-navigation/06-bottom-nav-intel`
...
| Slug | `06-bottom-nav-intel` |
| Suggested Dart name | `App06BottomNavIntel` |
| Used by | `09` |
...
Folder: `app-ui/00-shared/components/04-navigation/06-bottom-nav-intel/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/04-navigation/app_06_bottom_nav_intel.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/04-navigation/app_06_bottom_nav_intel_test.dart` |
...
4. Implement `App06BottomNavIntel` with:
