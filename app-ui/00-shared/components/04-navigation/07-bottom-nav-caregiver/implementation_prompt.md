# Implementation prompt — shared component `04-navigation/07-bottom-nav-caregiver`
...
| Slug | `07-bottom-nav-caregiver` |
| Suggested Dart name | `App07BottomNavCaregiver` |
| Used by | `02` |
...
Folder: `app-ui/00-shared/components/04-navigation/07-bottom-nav-caregiver/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/04-navigation/app_07_bottom_nav_caregiver.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/04-navigation/app_07_bottom_nav_caregiver_test.dart` |
...
4. Implement `App07BottomNavCaregiver` with:
