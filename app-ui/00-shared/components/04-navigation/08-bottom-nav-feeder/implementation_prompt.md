# Implementation prompt — shared component `04-navigation/08-bottom-nav-feeder`
...
| Slug | `08-bottom-nav-feeder` |
| Suggested Dart name | `App08BottomNavFeeder` |
| Used by | `14–19`, `21` |
...
Folder: `app-ui/00-shared/components/04-navigation/08-bottom-nav-feeder/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/04-navigation/app_08_bottom_nav_feeder.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/04-navigation/app_08_bottom_nav_feeder_test.dart` |
...
4. Implement `App08BottomNavFeeder` with:
