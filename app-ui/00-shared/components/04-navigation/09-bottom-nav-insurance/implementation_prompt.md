# Implementation prompt — shared component `04-navigation/09-bottom-nav-insurance`
...
| Slug | `09-bottom-nav-insurance` |
| Suggested Dart name | `App09BottomNavInsurance` |
| Used by | `23` |
...
Folder: `app-ui/00-shared/components/04-navigation/09-bottom-nav-insurance/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/04-navigation/app_09_bottom_nav_insurance.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/04-navigation/app_09_bottom_nav_insurance_test.dart` |
...
4. Implement `App09BottomNavInsurance` with:
