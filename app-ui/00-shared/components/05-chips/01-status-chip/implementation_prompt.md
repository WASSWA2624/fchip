# Implementation prompt — shared component `05-chips/01-status-chip`
...
Folder: `app-ui/00-shared/components/05-chips/01-status-chip/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/05-chips/app_01_status_chip.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/05-chips/app_01_status_chip_test.dart` |
