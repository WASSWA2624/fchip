# Implementation prompt — shared component `05-chips/02-risk-chip`
...
| Category | `05-chips` |
| Slug | `02-risk-chip` |
| Suggested Dart name | `App02RiskChip` |
...
Folder: `app-ui/00-shared/components/05-chips/02-risk-chip/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/05-chips/app_02_risk_chip.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/05-chips/app_02_risk_chip_test.dart` |
...
4. Implement `App02RiskChip` with:
