# Implementation prompt — shared component `05-chips/03-filter-chip-row`
...
| Category | `05-chips` |
| Slug | `03-filter-chip-row` |
| Suggested Dart name | `App03FilterChipRow` |
| Used by | `maps`, `lists` |
...
Folder: `app-ui/00-shared/components/05-chips/03-filter-chip-row/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/05-chips/app_03_filter_chip_row.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/05-chips/app_03_filter_chip_row_test.dart` |
...
4. Implement `App03FilterChipRow` with:
