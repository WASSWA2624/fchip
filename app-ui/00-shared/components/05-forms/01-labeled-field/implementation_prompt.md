# Implementation prompt — shared component `05-forms/01-labeled-field`
...
Folder: `app-ui/00-shared/components/05-forms/01-labeled-field/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/05-forms/app_01_labeled_field.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/05-forms/app_01_labeled_field_test.dart` |
