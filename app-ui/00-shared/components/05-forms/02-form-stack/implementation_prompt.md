# Implementation prompt — shared component `05-forms/02-form-stack`
...
Folder: `app-ui/00-shared/components/05-forms/02-form-stack/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/05-forms/app_02_form_stack.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/05-forms/app_02_form_stack_test.dart` |
