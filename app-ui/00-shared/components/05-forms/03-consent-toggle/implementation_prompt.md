# Implementation prompt — shared component `05-forms/03-consent-toggle`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Consent toggle** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Consent / privacy affirmation_
...
| Category | `05-forms` |
| Slug | `03-consent-toggle` |
| Suggested Dart name | `App03ConsentToggle` |
| Used by | `capture`, `self-report`, `EMR share` |
| Breakpoints | `mobile`, `tablet`, `desktop` |
| Themes | `light`, `dark`, `system` |

## Visual sources

Folder: `app-ui/00-shared/components/05-forms/03-consent-toggle/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/05-forms/app_03_consent_toggle.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/05-forms/app_03_consent_toggle_test.dart` |
...
4. Implement `App03ConsentToggle` with:
