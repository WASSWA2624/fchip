# Implementation prompt — shared component `05-forms/04-file-upload-field`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **File upload field** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Batch / dataset upload cue_
...
| Category | `05-forms` |
| Slug | `04-file-upload-field` |
| Suggested Dart name | `App04FileUploadField` |
| Used by | `NGO`, `lab batch`, `HMIS` |
| Breakpoints | `mobile`, `tablet`, `desktop` |
| Themes | `light`, `dark`, `system` |

## Visual sources

Folder: `app-ui/00-shared/components/05-forms/04-file-upload-field/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/05-forms/app_04_file_upload_field.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/05-forms/app_04_file_upload_field_test.dart` |
| Goldens | `frontend/test/shared/components/05-forms/goldens/` |
...
4. Implement `App04FileUploadField` with:
