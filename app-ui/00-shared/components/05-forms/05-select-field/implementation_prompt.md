# Implementation prompt — shared component `05-forms/05-select-field`
...
| Category | `05-forms` |
| Slug | `05-select-field` |
| Suggested Dart name | `App05SelectField` |
...
Folder: `app-ui/00-shared/components/05-forms/05-select-field/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/05-forms/app_05_select_field.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/05-forms/app_05_select_field_test.dart` |
...
4. Implement `App05SelectField` with:
