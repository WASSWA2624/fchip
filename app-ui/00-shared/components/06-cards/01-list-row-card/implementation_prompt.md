# Implementation prompt — shared component `06-cards/01-list-row-card`
...
| Category | `06-cards` |
| Slug | `01-list-row-card` |
| Suggested Dart name | `App01ListRowCard` |
...
Folder: `app-ui/00-shared/components/06-cards/01-list-row-card/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/06-cards/app_01_list_row_card.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/06-cards/app_01_list_row_card_test.dart` |
...
4. Implement `App01ListRowCard` with:
