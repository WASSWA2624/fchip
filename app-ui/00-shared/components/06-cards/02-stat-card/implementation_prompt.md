# Implementation prompt — shared component `06-cards/02-stat-card`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Stat card** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Single metric tile_
...
| Category | `06-cards` |
| Slug | `02-stat-card` |
| Suggested Dart name | `App02StatCard` |
| Used by | `dashboards` |
...
Folder: `app-ui/00-shared/components/06-cards/02-stat-card/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/06-cards/app_02_stat_card.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/06-cards/app_02_stat_card_test.dart` |
...
4. Implement `App02StatCard` with:
