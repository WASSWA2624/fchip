# Implementation prompt — shared component `06-cards/03-stat-card-row`
...
| Category | `06-cards` |
| Slug | `03-stat-card-row` |
| Suggested Dart name | `App03StatCardRow` |
...
Folder: `app-ui/00-shared/components/06-cards/03-stat-card-row/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/06-cards/app_03_stat_card_row.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/06-cards/app_03_stat_card_row_test.dart` |
...
4. Implement `App03StatCardRow` with:
