# Implementation prompt — shared component `06-cards/04-note-banner`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Note banner** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Calm info / positioning note_
...
| Category | `06-cards` |
| Slug | `04-note-banner` |
| Suggested Dart name | `App04NoteBanner` |
| Used by | `optional CHIS`, `EMR note` |
| Breakpoints | `mobile`, `tablet`, `desktop` |
| Themes | `light`, `dark`, `system` |

## Visual sources

Folder: `app-ui/00-shared/components/06-cards/04-note-banner/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/06-cards/app_04_note_banner.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/06-cards/app_04_note_banner_test.dart` |
...
4. Implement `App04NoteBanner` with:
