# Implementation prompt — shared component `06-cards/05-explainability-block`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Explainability block** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Why an alert fired_
...
| Category | `06-cards` |
| Slug | `05-explainability-block` |
| Suggested Dart name | `App05ExplainabilityBlock` |
| Used by | `alert follow-up`, `district warnings` |
| Breakpoints | `mobile`, `tablet`, `desktop` |
| Themes | `light`, `dark`, `system` |

## Visual sources

Folder: `app-ui/00-shared/components/06-cards/05-explainability-block/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/06-cards/app_05_explainability_block.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/06-cards/app_05_explainability_block_test.dart` |
| Goldens | `frontend/test/shared/components/06-cards/goldens/` |
...
4. Implement `App05ExplainabilityBlock` with:
