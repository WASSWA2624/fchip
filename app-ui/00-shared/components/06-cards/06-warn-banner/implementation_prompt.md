# Implementation prompt — shared component `06-cards/06-warn-banner`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Warn banner** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Attention callout_
...
| Category | `06-cards` |
| Slug | `06-warn-banner` |
| Suggested Dart name | `App06WarnBanner` |
| Used by | `gaps`, `consent` |
| Breakpoints | `mobile`, `tablet`, `desktop` |
| Themes | `light`, `dark`, `system` |

## Visual sources

Folder: `app-ui/00-shared/components/06-cards/06-warn-banner/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/06-cards/app_06_warn_banner.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/06-cards/app_06_warn_banner_test.dart` |
...
4. Implement `App06WarnBanner` with:
