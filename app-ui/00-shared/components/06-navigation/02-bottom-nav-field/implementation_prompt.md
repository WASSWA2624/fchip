# Implementation prompt — shared component `06-navigation/02-bottom-nav-field`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Bottom nav · field** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.
...
| Slug | `02-bottom-nav-field` |
| Suggested Dart name | `App02BottomNavField` |
| Used by | `01` |
...
Folder: `app-ui/00-shared/components/06-navigation/02-bottom-nav-field/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/06-navigation/app_02_bottom_nav_field.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/06-navigation/app_02_bottom_nav_field_test.dart` |
...
4. Implement `App02BottomNavField` with:
