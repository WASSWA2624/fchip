# Implementation prompt — shared component `06-navigation/03-bottom-nav-caregiver`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Bottom nav · caregiver** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Home · Report · Guidance · More_
...
| Slug | `03-bottom-nav-caregiver` |
| Suggested Dart name | `App03BottomNavCaregiver` |
| Used by | `02` |
...
Folder: `app-ui/00-shared/components/06-navigation/03-bottom-nav-caregiver/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/06-navigation/app_03_bottom_nav_caregiver.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/06-navigation/app_03_bottom_nav_caregiver_test.dart` |
...
4. Implement `App03BottomNavCaregiver` with:
