# Implementation prompt — shared component `06-navigation/04-bottom-nav-feeder`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Bottom nav · feeder** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: School / pharmacy / lab / MCH tabs_
...
| Slug | `04-bottom-nav-feeder` |
| Suggested Dart name | `App04BottomNavFeeder` |
| Used by | `14–19`, `21` |
...
Folder: `app-ui/00-shared/components/06-navigation/04-bottom-nav-feeder/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/06-navigation/app_04_bottom_nav_feeder.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/06-navigation/app_04_bottom_nav_feeder_test.dart` |
...
4. Implement `App04BottomNavFeeder` with:
