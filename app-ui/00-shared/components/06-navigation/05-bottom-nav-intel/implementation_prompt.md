# Implementation prompt — shared component `06-navigation/05-bottom-nav-intel`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Bottom nav · intelligence** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Ingest · AI · GIS · Guidance_
...
| Slug | `05-bottom-nav-intel` |
| Suggested Dart name | `App05BottomNavIntel` |
| Used by | `09` |
...
Folder: `app-ui/00-shared/components/06-navigation/05-bottom-nav-intel/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/06-navigation/app_05_bottom_nav_intel.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/06-navigation/app_05_bottom_nav_intel_test.dart` |
...
4. Implement `App05BottomNavIntel` with:
