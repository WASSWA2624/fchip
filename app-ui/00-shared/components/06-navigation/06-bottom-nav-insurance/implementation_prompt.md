# Implementation prompt — shared component `06-navigation/06-bottom-nav-insurance`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Bottom nav · insurance** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Prevent · Cohorts · Trends_
...
| Slug | `06-bottom-nav-insurance` |
| Suggested Dart name | `App06BottomNavInsurance` |
| Used by | `23` |
...
Folder: `app-ui/00-shared/components/06-navigation/06-bottom-nav-insurance/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/06-navigation/app_06_bottom_nav_insurance.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/06-navigation/app_06_bottom_nav_insurance_test.dart` |
...
4. Implement `App06BottomNavInsurance` with:
