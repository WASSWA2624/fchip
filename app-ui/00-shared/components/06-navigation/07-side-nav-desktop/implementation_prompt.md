# Implementation prompt — shared component `06-navigation/07-side-nav-desktop`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Side nav · desktop** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Desktop chrome navigation_
...
| Category | `06-navigation` |
| Slug | `07-side-nav-desktop` |
| Suggested Dart name | `App07SideNavDesktop` |
| Used by | `facility`, `district`, `admin`, `feeders` |
| Breakpoints | `mobile`, `tablet`, `desktop` |
| Themes | `light`, `dark`, `system` |

## Visual sources

Folder: `app-ui/00-shared/components/06-navigation/07-side-nav-desktop/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/06-navigation/app_07_side_nav_desktop.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/06-navigation/app_07_side_nav_desktop_test.dart` |
| Goldens | `frontend/test/shared/components/06-navigation/goldens/` |
...
4. Implement `App07SideNavDesktop` with:
