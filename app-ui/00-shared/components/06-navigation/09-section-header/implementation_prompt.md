# Implementation prompt — shared component `06-navigation/09-section-header`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Section header** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Title + subtitle block_
...
| Slug | `09-section-header` |
| Suggested Dart name | `App09SectionHeader` |
| Used by | `mobile/tablet screens` |
| Breakpoints | `mobile`, `tablet`, `desktop` |
| Themes | `light`, `dark`, `system` |

## Visual sources

Folder: `app-ui/00-shared/components/06-navigation/09-section-header/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/06-navigation/app_09_section_header.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/06-navigation/app_09_section_header_test.dart` |
...
4. Implement `App09SectionHeader` with:
