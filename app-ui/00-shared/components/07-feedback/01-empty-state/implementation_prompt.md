# Implementation prompt — shared component `07-feedback/01-empty-state`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Empty state** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: No items yet_
...
| Slug | `01-empty-state` |
| Suggested Dart name | `App01EmptyState` |
| Used by | `queues`, `inboxes` |
| Breakpoints | `mobile`, `tablet`, `desktop` |
| Themes | `light`, `dark`, `system` |

## Visual sources

Folder: `app-ui/00-shared/components/07-feedback/01-empty-state/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/07-feedback/app_01_empty_state.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/07-feedback/app_01_empty_state_test.dart` |
...
4. Implement `App01EmptyState` with:
