# Implementation prompt — shared component `07-feedback/03-success-toast`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Success toast** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Saved / synced confirmation_
...
| Slug | `03-success-toast` |
| Suggested Dart name | `App03SuccessToast` |
| Used by | `forms` |
...
Folder: `app-ui/00-shared/components/07-feedback/03-success-toast/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/07-feedback/app_03_success_toast.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/07-feedback/app_03_success_toast_test.dart` |
...
4. Implement `App03SuccessToast` with:
