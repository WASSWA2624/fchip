# Implementation prompt — shared component `07-feedback/04-error-inline`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Error inline** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Validation / feed error_
...
| Slug | `04-error-inline` |
| Suggested Dart name | `App04ErrorInline` |
| Used by | `forms`, `connectors` |
| Breakpoints | `mobile`, `tablet`, `desktop` |
| Themes | `light`, `dark`, `system` |

## Visual sources

Folder: `app-ui/00-shared/components/07-feedback/04-error-inline/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/07-feedback/app_04_error_inline.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/07-feedback/app_04_error_inline_test.dart` |
...
4. Implement `App04ErrorInline` with:
