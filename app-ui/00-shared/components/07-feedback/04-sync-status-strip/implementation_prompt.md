# Implementation prompt — shared component `07-feedback/04-sync-status-strip`
...
| Slug | `04-sync-status-strip` |
| Suggested Dart name | `App04SyncStatusStrip` |
...
Folder: `app-ui/00-shared/components/07-feedback/04-sync-status-strip/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/07-feedback/app_04_sync_status_strip.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/07-feedback/app_04_sync_status_strip_test.dart` |
...
4. Implement `App04SyncStatusStrip` with:
