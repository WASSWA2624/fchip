# Implementation prompt — shared component `07-feedback/05-error-inline`
...
| Slug | `05-error-inline` |
| Suggested Dart name | `App05ErrorInline` |
...
Folder: `app-ui/00-shared/components/07-feedback/05-error-inline/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/07-feedback/app_05_error_inline.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/07-feedback/app_05_error_inline_test.dart` |
...
4. Implement `App05ErrorInline` with:
