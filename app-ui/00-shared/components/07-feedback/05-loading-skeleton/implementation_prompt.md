# Implementation prompt — shared component `07-feedback/05-loading-skeleton`
...
| Slug | `05-loading-skeleton` |
| Suggested Dart name | `App05LoadingSkeleton` |
| Used by | `dashboards` |
...
Folder: `app-ui/00-shared/components/07-feedback/05-loading-skeleton/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/07-feedback/app_05_loading_skeleton.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/07-feedback/app_05_loading_skeleton_test.dart` |
...
4. Implement `App05LoadingSkeleton` with:
