# Implementation prompt — shared component `08-data-display/01-hotspot-map`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Hotspot map** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: GIS + climate overlay block_
...
| Slug | `01-hotspot-map` |
| Suggested Dart name | `App01HotspotMap` |
| Used by | `facility`, `district`, `coverage` |
| Breakpoints | `mobile`, `tablet`, `desktop` |
| Themes | `light`, `dark`, `system` |

## Visual sources

Folder: `app-ui/00-shared/components/08-data-display/01-hotspot-map/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/08-data-display/app_01_hotspot_map.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/08-data-display/app_01_hotspot_map_test.dart` |
...
4. Implement `App01HotspotMap` with:
