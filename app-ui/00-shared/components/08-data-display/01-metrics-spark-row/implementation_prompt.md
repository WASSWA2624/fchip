# Implementation prompt — shared component `08-data-display/01-metrics-spark-row`
...
| Slug | `01-metrics-spark-row` |
| Suggested Dart name | `App01MetricsSparkRow` |
...
Folder: `app-ui/00-shared/components/08-data-display/01-metrics-spark-row/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/08-data-display/app_01_metrics_spark_row.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/08-data-display/app_01_metrics_spark_row_test.dart` |
...
4. Implement `App01MetricsSparkRow` with:
