# Implementation prompt — shared component `08-data-display/02-queue-item`
...
| Slug | `02-queue-item` |
| Suggested Dart name | `App02QueueItem` |
| Used by | `07`, `16` |
...
Folder: `app-ui/00-shared/components/08-data-display/02-queue-item/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/08-data-display/app_02_queue_item.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/08-data-display/app_02_queue_item_test.dart` |
...
4. Implement `App02QueueItem` with:
