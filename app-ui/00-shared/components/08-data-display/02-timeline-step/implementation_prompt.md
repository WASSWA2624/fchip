# Implementation prompt — shared component `08-data-display/02-timeline-step`
...
| Slug | `02-timeline-step` |
| Suggested Dart name | `App02TimelineStep` |
...
Folder: `app-ui/00-shared/components/08-data-display/02-timeline-step/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/08-data-display/app_02_timeline_step.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/08-data-display/app_02_timeline_step_test.dart` |
...
4. Implement `App02TimelineStep` with:
