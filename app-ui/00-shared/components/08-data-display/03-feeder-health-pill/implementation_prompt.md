# Implementation prompt — shared component `08-data-display/03-feeder-health-pill`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Feeder health pill** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Healthy / degraded / silent_
...
| Category | `08-data-display` |
| Slug | `03-feeder-health-pill` |
| Suggested Dart name | `App03FeederHealthPill` |
| Used by | `09 feeder board`, `admin` |
| Breakpoints | `mobile`, `tablet`, `desktop` |
| Themes | `light`, `dark`, `system` |

## Visual sources

Folder: `app-ui/00-shared/components/08-data-display/03-feeder-health-pill/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/08-data-display/app_03_feeder_health_pill.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/08-data-display/app_03_feeder_health_pill_test.dart` |
| Goldens | `frontend/test/shared/components/08-data-display/goldens/` |
...
4. Implement `App03FeederHealthPill` with:
