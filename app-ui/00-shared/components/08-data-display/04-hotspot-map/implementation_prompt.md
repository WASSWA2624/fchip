# Implementation prompt — shared component `08-data-display/04-hotspot-map`
...
| Slug | `04-hotspot-map` |
| Suggested Dart name | `App04HotspotMap` |
...
Folder: `app-ui/00-shared/components/08-data-display/04-hotspot-map/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/08-data-display/app_04_hotspot_map.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/08-data-display/app_04_hotspot_map_test.dart` |
...
4. Implement `App04HotspotMap` with:
