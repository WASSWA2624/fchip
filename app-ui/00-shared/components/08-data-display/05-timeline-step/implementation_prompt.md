# Implementation prompt — shared component `08-data-display/05-timeline-step`

> Paste this whole file into an agent session when implementing this reusable component.

## Mission

Implement **Timeline step** as a single reusable Flutter widget in `frontend/lib/shared/components`, matching the six specimens, with no feature business logic, so every FCHIP screen can compose it safely.

_Purpose: Signal → prediction → action_
...
| Slug | `05-timeline-step` |
| Suggested Dart name | `App05TimelineStep` |
| Used by | `use-case detail` |
| Breakpoints | `mobile`, `tablet`, `desktop` |
| Themes | `light`, `dark`, `system` |

## Visual sources

Folder: `app-ui/00-shared/components/08-data-display/05-timeline-step/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/08-data-display/app_05_timeline_step.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/08-data-display/app_05_timeline_step_test.dart` |
...
4. Implement `App05TimelineStep` with:
