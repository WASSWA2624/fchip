# Implementation prompt — shared component `brand/cascade-footer`
...
| Category | `brand` |
| Slug | `cascade-footer` |
| Suggested Dart name | `AppCascadeFooter` |
...
Folder: `app-ui/00-shared/components/brand/cascade-footer/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/brand/app_cascade_footer.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/brand/app_cascade_footer_test.dart` |
...
4. Implement `AppCascadeFooter` with:
