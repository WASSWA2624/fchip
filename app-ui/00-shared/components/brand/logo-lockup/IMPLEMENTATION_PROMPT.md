# Implementation prompt — shared component `brand/logo-lockup`
...
| Category | `brand` |
| Slug | `logo-lockup` |
| Suggested Dart name | `AppLogoLockup` |
...
Folder: `app-ui/00-shared/components/brand/logo-lockup/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/brand/app_logo_lockup.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/brand/app_logo_lockup_test.dart` |
...
4. Implement `AppLogoLockup` with:
