# Implementation prompt — shared component `brand/master-loop-badge`
...
| Category | `brand` |
| Slug | `master-loop-badge` |
| Suggested Dart name | `AppMasterLoopBadge` |
...
Folder: `app-ui/00-shared/components/brand/master-loop-badge/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/brand/app_master_loop_badge.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/brand/app_master_loop_badge_test.dart` |
| Goldens | `frontend/test/shared/components/brand/goldens/` |
...
4. Implement `AppMasterLoopBadge` with:
