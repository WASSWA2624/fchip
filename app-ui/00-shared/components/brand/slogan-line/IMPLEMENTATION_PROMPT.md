# Implementation prompt — shared component `brand/slogan-line`
...
| Category | `brand` |
| Slug | `slogan-line` |
| Suggested Dart name | `AppSloganLine` |
...
Folder: `app-ui/00-shared/components/brand/slogan-line/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/brand/app_slogan_line.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/brand/app_slogan_line_test.dart` |
...
4. Implement `AppSloganLine` with:
