# Implementation prompt — shared component `buttons/secondary-cta`
...
| Category | `buttons` |
| Slug | `secondary-cta` |
| Suggested Dart name | `AppSecondaryCta` |
...
Folder: `app-ui/00-shared/components/buttons/secondary-cta/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/buttons/app_secondary_cta.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/buttons/app_secondary_cta_test.dart` |
...
4. Implement `AppSecondaryCta` with:
