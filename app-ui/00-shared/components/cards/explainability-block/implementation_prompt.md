# Implementation prompt — shared component `cards/explainability-block`
...
| Category | `cards` |
| Slug | `explainability-block` |
| Suggested Dart name | `AppExplainabilityBlock` |
...
Folder: `app-ui/00-shared/components/cards/explainability-block/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/cards/app_explainability_block.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/cards/app_explainability_block_test.dart` |
| Goldens | `frontend/test/shared/components/cards/goldens/` |
...
4. Implement `AppExplainabilityBlock` with:
