# Implementation prompt — shared component `cards/list-row-card`
...
| Category | `cards` |
| Slug | `list-row-card` |
| Suggested Dart name | `AppListRowCard` |
...
Folder: `app-ui/00-shared/components/cards/list-row-card/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/cards/app_list_row_card.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/cards/app_list_row_card_test.dart` |
...
4. Implement `AppListRowCard` with:
