# Implementation prompt — shared component `cards/note-banner`
...
| Category | `cards` |
| Slug | `note-banner` |
| Suggested Dart name | `AppNoteBanner` |
...
Folder: `app-ui/00-shared/components/cards/note-banner/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/cards/app_note_banner.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/cards/app_note_banner_test.dart` |
...
4. Implement `AppNoteBanner` with:
