# Implementation prompt — shared component `cards/stat-card-row`
...
| Category | `cards` |
| Slug | `stat-card-row` |
| Suggested Dart name | `AppStatCardRow` |
...
Folder: `app-ui/00-shared/components/cards/stat-card-row/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/cards/app_stat_card_row.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/cards/app_stat_card_row_test.dart` |
...
4. Implement `AppStatCardRow` with:
