# Implementation prompt — shared component `cards/stat-card`
...
| Category | `cards` |
| Slug | `stat-card` |
| Suggested Dart name | `AppStatCard` |
| Used by | `dashboards` |
...
Folder: `app-ui/00-shared/components/cards/stat-card/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/cards/app_stat_card.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/cards/app_stat_card_test.dart` |
