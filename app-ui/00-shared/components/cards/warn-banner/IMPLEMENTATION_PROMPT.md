# Implementation prompt — shared component `cards/warn-banner`
...
| Category | `cards` |
| Slug | `warn-banner` |
| Suggested Dart name | `AppWarnBanner` |
...
Folder: `app-ui/00-shared/components/cards/warn-banner/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/cards/app_warn_banner.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/cards/app_warn_banner_test.dart` |
...
4. Implement `AppWarnBanner` with:
