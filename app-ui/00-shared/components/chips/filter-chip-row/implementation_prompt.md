# Implementation prompt — shared component `chips/filter-chip-row`
...
| Suggested Dart name | `AppFilterChipRow` |
| Used by | `maps`, `lists` |
...
Folder: `app-ui/00-shared/components/chips/filter-chip-row/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/chips/app_filter_chip_row.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/chips/app_filter_chip_row_test.dart` |
...
4. Implement `AppFilterChipRow` with:
