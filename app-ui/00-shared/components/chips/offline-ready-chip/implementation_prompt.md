# Implementation prompt — shared component `chips/offline-ready-chip`
...
| Category | `chips` |
| Slug | `offline-ready-chip` |
| Suggested Dart name | `AppOfflineReadyChip` |
| Used by | `CHW`, `feeders` |
...
Folder: `app-ui/00-shared/components/chips/offline-ready-chip/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/chips/app_offline_ready_chip.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/chips/app_offline_ready_chip_test.dart` |
| Goldens | `frontend/test/shared/components/chips/goldens/` |
...
4. Implement `AppOfflineReadyChip` with:
