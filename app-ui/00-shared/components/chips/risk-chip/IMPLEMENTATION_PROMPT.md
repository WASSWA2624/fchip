# Implementation prompt — shared component `chips/risk-chip`
...
| Category | `chips` |
| Slug | `risk-chip` |
| Suggested Dart name | `AppRiskChip` |
...
Folder: `app-ui/00-shared/components/chips/risk-chip/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/chips/app_risk_chip.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/chips/app_risk_chip_test.dart` |
