# Implementation prompt — shared component `chips/status-chip`
...
| Category | `chips` |
| Slug | `status-chip` |
| Suggested Dart name | `AppStatusChip` |
...
Folder: `app-ui/00-shared/components/chips/status-chip/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/chips/app_status_chip.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/chips/app_status_chip_test.dart` |
...
4. Implement `AppStatusChip` with:
