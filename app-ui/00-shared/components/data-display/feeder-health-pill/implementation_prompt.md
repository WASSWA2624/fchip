# Implementation prompt — shared component `data-display/feeder-health-pill`
...
| Slug | `feeder-health-pill` |
| Suggested Dart name | `AppFeederHealthPill` |
...
Folder: `app-ui/00-shared/components/data-display/feeder-health-pill/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/data-display/app_feeder_health_pill.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/data-display/app_feeder_health_pill_test.dart` |
| Goldens | `frontend/test/shared/components/data-display/goldens/` |
...
4. Implement `AppFeederHealthPill` with:
