# Implementation prompt — shared component `data-display/hotspot-map`
...
| Slug | `hotspot-map` |
| Suggested Dart name | `AppHotspotMap` |
...
Folder: `app-ui/00-shared/components/data-display/hotspot-map/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/data-display/app_hotspot_map.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/data-display/app_hotspot_map_test.dart` |
...
4. Implement `AppHotspotMap` with:
