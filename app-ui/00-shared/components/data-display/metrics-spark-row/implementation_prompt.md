# Implementation prompt — shared component `data-display/metrics-spark-row`
...
| Slug | `metrics-spark-row` |
| Suggested Dart name | `AppMetricsSparkRow` |
...
Folder: `app-ui/00-shared/components/data-display/metrics-spark-row/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/data-display/app_metrics_spark_row.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/data-display/app_metrics_spark_row_test.dart` |
...
4. Implement `AppMetricsSparkRow` with:
