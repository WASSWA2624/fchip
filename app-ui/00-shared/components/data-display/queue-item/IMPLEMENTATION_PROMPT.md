# Implementation prompt — shared component `data-display/queue-item`
...
| Slug | `queue-item` |
| Suggested Dart name | `AppQueueItem` |
| Used by | `07`, `16` |
...
Folder: `app-ui/00-shared/components/data-display/queue-item/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/data-display/app_queue_item.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/data-display/app_queue_item_test.dart` |
