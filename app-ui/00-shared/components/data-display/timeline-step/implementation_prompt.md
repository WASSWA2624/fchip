# Implementation prompt — shared component `data-display/timeline-step`
...
| Slug | `timeline-step` |
| Suggested Dart name | `AppTimelineStep` |
...
Folder: `app-ui/00-shared/components/data-display/timeline-step/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/data-display/app_timeline_step.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/data-display/app_timeline_step_test.dart` |
...
4. Implement `AppTimelineStep` with:
