# Implementation prompt — shared component `feedback/empty-state`
...
| Category | `feedback` |
| Slug | `empty-state` |
| Suggested Dart name | `AppEmptyState` |
...
Folder: `app-ui/00-shared/components/feedback/empty-state/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/feedback/app_empty_state.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/feedback/app_empty_state_test.dart` |
...
4. Implement `AppEmptyState` with:
