# Implementation prompt — shared component `feedback/error-inline`
...
| Category | `feedback` |
| Slug | `error-inline` |
| Suggested Dart name | `AppErrorInline` |
...
Folder: `app-ui/00-shared/components/feedback/error-inline/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/feedback/app_error_inline.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/feedback/app_error_inline_test.dart` |
...
4. Implement `AppErrorInline` with:
