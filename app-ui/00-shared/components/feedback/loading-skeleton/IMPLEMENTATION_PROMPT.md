# Implementation prompt — shared component `feedback/loading-skeleton`
...
| Suggested Dart name | `AppLoadingSkeleton` |
| Used by | `dashboards` |
...
Folder: `app-ui/00-shared/components/feedback/loading-skeleton/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/feedback/app_loading_skeleton.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/feedback/app_loading_skeleton_test.dart` |
...
4. Implement `AppLoadingSkeleton` with:
