# Implementation prompt — shared component `feedback/success-toast`
...
| Category | `feedback` |
| Slug | `success-toast` |
| Suggested Dart name | `AppSuccessToast` |
| Used by | `forms` |
...
Folder: `app-ui/00-shared/components/feedback/success-toast/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/feedback/app_success_toast.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/feedback/app_success_toast_test.dart` |
...
4. Implement `AppSuccessToast` with:
