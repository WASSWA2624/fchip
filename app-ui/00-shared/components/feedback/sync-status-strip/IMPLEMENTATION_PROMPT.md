# Implementation prompt — shared component `feedback/sync-status-strip`
...
| Category | `feedback` |
| Slug | `sync-status-strip` |
| Suggested Dart name | `AppSyncStatusStrip` |
...
Folder: `app-ui/00-shared/components/feedback/sync-status-strip/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/feedback/app_sync_status_strip.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/feedback/app_sync_status_strip_test.dart` |
| Goldens | `frontend/test/shared/components/feedback/goldens/` |
...
4. Implement `AppSyncStatusStrip` with:
