# Implementation prompt — shared component `forms/consent-toggle`
...
| Category | `forms` |
| Slug | `consent-toggle` |
| Suggested Dart name | `AppConsentToggle` |
...
Folder: `app-ui/00-shared/components/forms/consent-toggle/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/forms/app_consent_toggle.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/forms/app_consent_toggle_test.dart` |
...
4. Implement `AppConsentToggle` with:
