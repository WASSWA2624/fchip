# Implementation prompt — shared component `forms/file-upload-field`
...
| Category | `forms` |
| Slug | `file-upload-field` |
| Suggested Dart name | `AppFileUploadField` |
...
Folder: `app-ui/00-shared/components/forms/file-upload-field/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/forms/app_file_upload_field.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/forms/app_file_upload_field_test.dart` |
| Goldens | `frontend/test/shared/components/forms/goldens/` |
...
4. Implement `AppFileUploadField` with:
