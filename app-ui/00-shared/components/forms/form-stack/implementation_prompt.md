# Implementation prompt — shared component `forms/form-stack`
...
| Category | `forms` |
| Slug | `form-stack` |
| Suggested Dart name | `AppFormStack` |
...
Folder: `app-ui/00-shared/components/forms/form-stack/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/forms/app_form_stack.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/forms/app_form_stack_test.dart` |
