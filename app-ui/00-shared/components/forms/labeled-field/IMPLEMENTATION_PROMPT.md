# Implementation prompt — shared component `forms/labeled-field`
...
| Category | `forms` |
| Slug | `labeled-field` |
| Suggested Dart name | `AppLabeledField` |
| Used by | `all forms` |
...
Folder: `app-ui/00-shared/components/forms/labeled-field/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/forms/app_labeled_field.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/forms/app_labeled_field_test.dart` |
...
4. Implement `AppLabeledField` with:
