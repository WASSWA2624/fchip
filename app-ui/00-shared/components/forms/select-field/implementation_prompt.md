# Implementation prompt — shared component `forms/select-field`
...
| Category | `forms` |
| Slug | `select-field` |
| Suggested Dart name | `AppSelectField` |
...
Folder: `app-ui/00-shared/components/forms/select-field/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/forms/app_select_field.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/forms/app_select_field_test.dart` |
...
4. Implement `AppSelectField` with:
