# Implementation prompt — shared component `navigation/bottom-nav-caregiver`
...
| Category | `navigation` |
| Slug | `bottom-nav-caregiver` |
| Suggested Dart name | `AppBottomNavCaregiver` |
| Used by | `02` |
...
Folder: `app-ui/00-shared/components/navigation/bottom-nav-caregiver/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/navigation/app_bottom_nav_caregiver.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/navigation/app_bottom_nav_caregiver_test.dart` |
...
4. Implement `AppBottomNavCaregiver` with:
