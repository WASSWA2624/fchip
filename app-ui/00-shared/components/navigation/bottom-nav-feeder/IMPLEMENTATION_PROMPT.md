# Implementation prompt — shared component `navigation/bottom-nav-feeder`
...
| Category | `navigation` |
| Slug | `bottom-nav-feeder` |
| Suggested Dart name | `AppBottomNavFeeder` |
| Used by | `14–19`, `21` |
...
Folder: `app-ui/00-shared/components/navigation/bottom-nav-feeder/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/navigation/app_bottom_nav_feeder.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/navigation/app_bottom_nav_feeder_test.dart` |
...
4. Implement `AppBottomNavFeeder` with:
