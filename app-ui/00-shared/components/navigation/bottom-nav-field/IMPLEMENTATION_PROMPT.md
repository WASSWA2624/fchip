# Implementation prompt — shared component `navigation/bottom-nav-field`
...
| Category | `navigation` |
| Slug | `bottom-nav-field` |
| Suggested Dart name | `AppBottomNavField` |
| Used by | `01` |
...
Folder: `app-ui/00-shared/components/navigation/bottom-nav-field/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/navigation/app_bottom_nav_field.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/navigation/app_bottom_nav_field_test.dart` |
...
4. Implement `AppBottomNavField` with:
