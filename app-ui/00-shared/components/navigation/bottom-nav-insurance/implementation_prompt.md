# Implementation prompt — shared component `navigation/bottom-nav-insurance`
...
| Category | `navigation` |
| Slug | `bottom-nav-insurance` |
| Suggested Dart name | `AppBottomNavInsurance` |
| Used by | `23` |
...
Folder: `app-ui/00-shared/components/navigation/bottom-nav-insurance/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/navigation/app_bottom_nav_insurance.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/navigation/app_bottom_nav_insurance_test.dart` |
...
4. Implement `AppBottomNavInsurance` with:
