# Implementation prompt — shared component `navigation/bottom-nav-intel`
...
| Category | `navigation` |
| Slug | `bottom-nav-intel` |
| Suggested Dart name | `AppBottomNavIntel` |
| Used by | `09` |
...
Folder: `app-ui/00-shared/components/navigation/bottom-nav-intel/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/navigation/app_bottom_nav_intel.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/navigation/app_bottom_nav_intel_test.dart` |
...
4. Implement `AppBottomNavIntel` with:
