# Implementation prompt — shared component `navigation/role-picker-row`
...
| Category | `navigation` |
| Slug | `role-picker-row` |
| Suggested Dart name | `AppRolePickerRow` |
...
Folder: `app-ui/00-shared/components/navigation/role-picker-row/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/navigation/app_role_picker_row.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/navigation/app_role_picker_row_test.dart` |
...
4. Implement `AppRolePickerRow` with:
