# Implementation prompt — shared component `navigation/section-header`
...
| Category | `navigation` |
| Slug | `section-header` |
| Suggested Dart name | `AppSectionHeader` |
...
Folder: `app-ui/00-shared/components/navigation/section-header/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/navigation/app_section_header.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/navigation/app_section_header_test.dart` |
...
4. Implement `AppSectionHeader` with:
