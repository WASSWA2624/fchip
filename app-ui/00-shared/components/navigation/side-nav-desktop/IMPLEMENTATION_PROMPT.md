# Implementation prompt — shared component `navigation/side-nav-desktop`
...
| Category | `navigation` |
| Slug | `side-nav-desktop` |
| Suggested Dart name | `AppSideNavDesktop` |
...
Folder: `app-ui/00-shared/components/navigation/side-nav-desktop/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/navigation/app_side_nav_desktop.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/navigation/app_side_nav_desktop_test.dart` |
| Goldens | `frontend/test/shared/components/navigation/goldens/` |
...
4. Implement `AppSideNavDesktop` with:
