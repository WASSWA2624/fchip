# Implementation prompt — shared component `navigation/top-app-bar`
...
| Category | `navigation` |
| Slug | `top-app-bar` |
| Suggested Dart name | `AppTopAppBar` |
...
Folder: `app-ui/00-shared/components/navigation/top-app-bar/`
...
| Layer | Path |
| --- | --- |
| Widget | `frontend/lib/shared/components/navigation/app_top_app_bar.dart` |
| Barrel / exports | `frontend/lib/shared/components/` |
| Widget tests | `frontend/test/shared/components/navigation/app_top_app_bar_test.dart` |
