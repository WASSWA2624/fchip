# Implementation prompt — `01-chw-vht-mobile/03-worklist-loading`
...
| Screen slug | `03-worklist-loading` |
| Chronology | `S-015` |
| Slice | `VS-01` |
| Phase | `mvp` |
| Deferred | `false` |
| Chronology status | `not-started` |
| Route | `/01-chw-vht-mobile/03-worklist-loading` |
...
Folder: `app-ui/01-chw-vht-mobile/03-worklist-loading/`
...
| Page | `frontend/lib/features/chw_vht_mobile/presentation/pages/03_worklist_loading_page.dart` |
...
| Router entry | `frontend/lib/app/router/` (route must equal `/01-chw-vht-mobile/03-worklist-loading`) |
...
8. Register route `/01-chw-vht-mobile/03-worklist-loading` with the access guard for roles `chw`, `vht`.
...
11. Add ARB keys under `01_chw_vht_mobile.03_worklist_loading` only — no hard-coded user strings.
