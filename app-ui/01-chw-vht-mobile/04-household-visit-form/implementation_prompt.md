# Implementation prompt — `01-chw-vht-mobile/04-household-visit-form`
...
| Screen slug | `04-household-visit-form` |
| Chronology | `S-016` |
| Slice | `VS-01` |
| Phase | `mvp` |
| Deferred | `false` |
...
Folder: `app-ui/01-chw-vht-mobile/04-household-visit-form/`
...
| Page | `frontend/lib/features/chw_vht_mobile/presentation/pages/04_household_visit_form_page.dart` |
