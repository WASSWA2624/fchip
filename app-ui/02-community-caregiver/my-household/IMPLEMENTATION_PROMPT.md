# Implementation prompt — `02-community-caregiver/my-household`
...
| Route | `/02-community-caregiver/my-household` |
| Parent route | `/02-community-caregiver/my-household` |
| Layout | `feeder-home` |
...
| Localization prefix | `02_community_caregiver.my_household` |
...
Folder: `app-ui/02-community-caregiver/my-household/`
...
| Router entry | `frontend/lib/app/router/` (route must equal `/02-community-caregiver/my-household`) |
...
8. Register route `/02-community-caregiver/my-household` with the access guard for roles `caregiver`, `community-member`.
...
11. Add ARB keys under `02_community_caregiver.my_household` only — no hard-coded user strings.
