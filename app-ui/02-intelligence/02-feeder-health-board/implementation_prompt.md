# Implementation prompt — `02-intelligence/02-feeder-health-board`
...
| Screen slug | `02-feeder-health-board` |
| Chronology | `S-028` |
| Slice | `VS-02` |
| Phase | `mvp` |
| Deferred | `false` |
...
Folder: `app-ui/02-intelligence/02-feeder-health-board/`
...
| Page | `frontend/lib/features/intelligence/presentation/pages/02_feeder_health_board_page.dart` |
