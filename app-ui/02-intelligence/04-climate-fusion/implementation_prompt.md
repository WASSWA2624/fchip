# Implementation prompt — `02-intelligence/04-climate-fusion`
...
| Screen slug | `04-climate-fusion` |
| Chronology | `S-053` |
| Slice | `VS-02` |
| Phase | `mvp` |
| Deferred | `false` |
| Chronology status | `not-started` |
| Route | `/02-intelligence/04-climate-fusion` |
...
| Localization prefix | `02_intelligence.04_climate_fusion` |
...
Folder: `app-ui/02-intelligence/04-climate-fusion/`
...
| Page | `frontend/lib/features/intelligence/presentation/pages/04_climate_fusion_page.dart` |
...
| Router entry | `frontend/lib/app/router/` (route must equal `/02-intelligence/04-climate-fusion`) |
...
8. Register route `/02-intelligence/04-climate-fusion` with the access guard for roles `intelligence-analyst`, `platform-operator`.
...
11. Add ARB keys under `02_intelligence.04_climate_fusion` only — no hard-coded user strings.
