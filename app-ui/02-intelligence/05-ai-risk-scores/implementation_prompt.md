# Implementation prompt — `02-intelligence/05-ai-risk-scores`
...
| Screen slug | `05-ai-risk-scores` |
| Chronology | `S-054` |
| Slice | `VS-02` |
| Phase | `mvp` |
| Deferred | `false` |
| Chronology status | `not-started` |
| Route | `/02-intelligence/05-ai-risk-scores` |
| Parent route | `/02-intelligence/05-ai-risk-scores` |
...
| Localization prefix | `02_intelligence.05_ai_risk_scores` |
...
Folder: `app-ui/02-intelligence/05-ai-risk-scores/`
...
| Page | `frontend/lib/features/intelligence/presentation/pages/05_ai_risk_scores_page.dart` |
...
| Router entry | `frontend/lib/app/router/` (route must equal `/02-intelligence/05-ai-risk-scores`) |
...
8. Register route `/02-intelligence/05-ai-risk-scores` with the access guard for roles `intelligence-analyst`, `platform-operator`.
...
11. Add ARB keys under `02_intelligence.05_ai_risk_scores` only — no hard-coded user strings.
