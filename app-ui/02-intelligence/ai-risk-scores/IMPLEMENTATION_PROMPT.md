# Implementation prompt — `02-intelligence/ai-risk-scores`
...
| Route | `/02-intelligence/ai-risk-scores` |
| Parent route | `/02-intelligence/ai-risk-scores` |
...
| Localization prefix | `02_intelligence.ai_risk_scores` |
...
Folder: `app-ui/02-intelligence/ai-risk-scores/`
...
| Router entry | `frontend/lib/app/router/` (route must equal `/02-intelligence/ai-risk-scores`) |
...
8. Register route `/02-intelligence/ai-risk-scores` with the access guard for roles `intelligence-analyst`, `platform-operator`.
...
11. Add ARB keys under `02_intelligence.ai_risk_scores` only — no hard-coded user strings.
