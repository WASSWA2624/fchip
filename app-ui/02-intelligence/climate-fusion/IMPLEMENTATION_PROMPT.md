# Implementation prompt — `02-intelligence/climate-fusion`
...
| Route | `/02-intelligence/climate-fusion` |
...
| Localization prefix | `02_intelligence.climate_fusion` |
...
Folder: `app-ui/02-intelligence/climate-fusion/`
...
| Router entry | `frontend/lib/app/router/` (route must equal `/02-intelligence/climate-fusion`) |
...
8. Register route `/02-intelligence/climate-fusion` with the access guard for roles `intelligence-analyst`, `platform-operator`.
...
11. Add ARB keys under `02_intelligence.climate_fusion` only — no hard-coded user strings.
