# Implementation prompt — `02-intelligence/gis-explorer`
...
| Route | `/02-intelligence/gis-explorer` |
| Parent route | `/02-intelligence/gis-explorer` |
| Layout | `map-explorer` |
...
| Localization prefix | `02_intelligence.gis_explorer` |
...
Folder: `app-ui/02-intelligence/gis-explorer/`
...
| Router entry | `frontend/lib/app/router/` (route must equal `/02-intelligence/gis-explorer`) |
...
8. Register route `/02-intelligence/gis-explorer` with the access guard for roles `intelligence-analyst`, `platform-operator`.
...
11. Add ARB keys under `02_intelligence.gis_explorer` only — no hard-coded user strings.
