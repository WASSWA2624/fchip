# Implementation prompt — `04-cascade-metrics/indicators-overview`
...
| Route | `/04-cascade-metrics/indicators-overview` |
| Parent route | `/04-cascade-metrics/indicators-overview` |
...
| Localization prefix | `04_cascade_metrics.indicators_overview` |
...
Folder: `app-ui/04-cascade-metrics/indicators-overview/`
...
- `app-ui/04-cascade-metrics/README.md`
...
| Router entry | `frontend/lib/app/router/` (route must equal `/04-cascade-metrics/indicators-overview`) |
...
8. Register route `/04-cascade-metrics/indicators-overview` with the access guard for roles `district-health-officer`, `moh`.
...
11. Add ARB keys under `04_cascade_metrics.indicators_overview` only — no hard-coded user strings.
