# Implementation prompt — `04-facility-dashboard/01-overview`
...
Folder: `app-ui/04-facility-dashboard/01-overview/`
...
| Page | `frontend/lib/features/facility_dashboard/presentation/pages/01_overview_page.dart` |
