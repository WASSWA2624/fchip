# Implementation prompt — `04-facility-dashboard/05-outreach-priorities`
...
| Screen slug | `05-outreach-priorities` |
| Chronology | `S-036` |
| Slice | `VS-04` |
| Phase | `mvp` |
| Deferred | `false` |
| Chronology status | `not-started` |
| Route | `/04-facility-dashboard/05-outreach-priorities` |
...
| Localization prefix | `04_facility_dashboard.05_outreach_priorities` |
...
Folder: `app-ui/04-facility-dashboard/05-outreach-priorities/`
...
| Page | `frontend/lib/features/facility_dashboard/presentation/pages/05_outreach_priorities_page.dart` |
...
| Router entry | `frontend/lib/app/router/` (route must equal `/04-facility-dashboard/05-outreach-priorities`) |
...
8. Register route `/04-facility-dashboard/05-outreach-priorities` with the access guard for roles `facility-clinician`, `facility-manager`.
...
11. Add ARB keys under `04_facility_dashboard.05_outreach_priorities` only — no hard-coded user strings.
