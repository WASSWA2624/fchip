# Implementation prompt — `04-facility-dashboard/outreach-priorities`
...
| Route | `/04-facility-dashboard/outreach-priorities` |
...
| Localization prefix | `04_facility_dashboard.outreach_priorities` |
...
Folder: `app-ui/04-facility-dashboard/outreach-priorities/`
...
| Router entry | `frontend/lib/app/router/` (route must equal `/04-facility-dashboard/outreach-priorities`) |
...
8. Register route `/04-facility-dashboard/outreach-priorities` with the access guard for roles `facility-clinician`, `facility-manager`.
...
11. Add ARB keys under `04_facility_dashboard.outreach_priorities` only — no hard-coded user strings.
