# Implementation prompt — `05-chis-livelihoods/claims-access`
...
| Route | `/05-chis-livelihoods/claims-access` |
| Parent route | `/11-ngo-partner/programme-monitoring` |
...
| Localization prefix | `05_chis_livelihoods.claims_access` |
...
Folder: `app-ui/05-chis-livelihoods/claims-access/`
...
- `app-ui/05-chis-livelihoods/README.md`
...
| Router entry | `frontend/lib/app/router/` (route must equal `/05-chis-livelihoods/claims-access`) |
...
8. Register route `/05-chis-livelihoods/claims-access` with the access guard for roles `ngo-partner`, `researcher`.
...
11. Add ARB keys under `05_chis_livelihoods.claims_access` only — no hard-coded user strings.
