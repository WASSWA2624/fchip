# Implementation prompt — `05-referrals-desk/01-referral-queue`
...
Folder: `app-ui/05-referrals-desk/01-referral-queue/`
...
| Page | `frontend/lib/features/referrals_desk/presentation/pages/01_referral_queue_page.dart` |
