# Implementation prompt — `06-emr-connector/04-push-event-log`
...
Folder: `app-ui/06-emr-connector/04-push-event-log/`
...
| Page | `frontend/lib/features/emr_connector/presentation/pages/04_push_event_log_page.dart` |
