# Implementation prompt — `07-climate-feeds/02-rainfall-temperature`
...
| Screen slug | `02-rainfall-temperature` |
| Chronology | `S-049` |
| Slice | `VS-07` |
| Phase | `mvp` |
| Deferred | `false` |
| Chronology status | `not-started` |
| Route | `/07-climate-feeds/02-rainfall-temperature` |
| Parent route | `/07-climate-feeds/02-rainfall-temperature` |
...
| Localization prefix | `07_climate_feeds.02_rainfall_temperature` |
...
Folder: `app-ui/07-climate-feeds/02-rainfall-temperature/`
...
| Page | `frontend/lib/features/climate_feeds/presentation/pages/02_rainfall_temperature_page.dart` |
...
| Router entry | `frontend/lib/app/router/` (route must equal `/07-climate-feeds/02-rainfall-temperature`) |
...
8. Register route `/07-climate-feeds/02-rainfall-temperature` with the access guard for roles `climate-data-operator`.
...
11. Add ARB keys under `07_climate_feeds.02_rainfall_temperature` only — no hard-coded user strings.
