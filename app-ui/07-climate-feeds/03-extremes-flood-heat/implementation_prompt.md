# Implementation prompt — `07-climate-feeds/03-extremes-flood-heat`
...
| Screen slug | `03-extremes-flood-heat` |
| Chronology | `S-050` |
| Slice | `VS-07` |
| Phase | `mvp` |
| Deferred | `false` |
| Chronology status | `not-started` |
| Route | `/07-climate-feeds/03-extremes-flood-heat` |
| Parent route | `/07-climate-feeds/03-extremes-flood-heat` |
...
| Localization prefix | `07_climate_feeds.03_extremes_flood_heat` |
...
Folder: `app-ui/07-climate-feeds/03-extremes-flood-heat/`
...
| Page | `frontend/lib/features/climate_feeds/presentation/pages/03_extremes_flood_heat_page.dart` |
...
| Router entry | `frontend/lib/app/router/` (route must equal `/07-climate-feeds/03-extremes-flood-heat`) |
...
8. Register route `/07-climate-feeds/03-extremes-flood-heat` with the access guard for roles `climate-data-operator`.
...
11. Add ARB keys under `07_climate_feeds.03_extremes_flood_heat` only — no hard-coded user strings.
