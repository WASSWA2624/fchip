# Implementation prompt — `07-climate-feeds/extremes-flood-heat`
...
| Route | `/07-climate-feeds/extremes-flood-heat` |
| Parent route | `/07-climate-feeds/extremes-flood-heat` |
...
| Localization prefix | `07_climate_feeds.extremes_flood_heat` |
...
Folder: `app-ui/07-climate-feeds/extremes-flood-heat/`
...
| Router entry | `frontend/lib/app/router/` (route must equal `/07-climate-feeds/extremes-flood-heat`) |
...
8. Register route `/07-climate-feeds/extremes-flood-heat` with the access guard for roles `climate-data-operator`.
...
11. Add ARB keys under `07_climate_feeds.extremes_flood_heat` only — no hard-coded user strings.
