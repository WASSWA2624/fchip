# Implementation prompt — `07-climate-feeds/rainfall-temperature`
...
| Route | `/07-climate-feeds/rainfall-temperature` |
| Parent route | `/07-climate-feeds/rainfall-temperature` |
...
| Localization prefix | `07_climate_feeds.rainfall_temperature` |
...
Folder: `app-ui/07-climate-feeds/rainfall-temperature/`
...
| Router entry | `frontend/lib/app/router/` (route must equal `/07-climate-feeds/rainfall-temperature`) |
...
8. Register route `/07-climate-feeds/rainfall-temperature` with the access guard for roles `climate-data-operator`.
...
11. Add ARB keys under `07_climate_feeds.rainfall_temperature` only — no hard-coded user strings.
