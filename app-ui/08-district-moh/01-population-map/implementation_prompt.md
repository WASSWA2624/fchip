# Implementation prompt — `08-district-moh/01-population-map`
...
Folder: `app-ui/08-district-moh/01-population-map/`
...
| Page | `frontend/lib/features/district_moh/presentation/pages/01_population_map_page.dart` |
