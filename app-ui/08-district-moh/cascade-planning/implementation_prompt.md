# Implementation prompt — `08-district-moh/cascade-planning`
...
| Route | `/08-district-moh/cascade-planning` |
| Parent route | `/08-district-moh/cascade-planning` |
...
| Localization prefix | `08_district_moh.cascade_planning` |
...
Folder: `app-ui/08-district-moh/cascade-planning/`
...
| Router entry | `frontend/lib/app/router/` (route must equal `/08-district-moh/cascade-planning`) |
...
8. Register route `/08-district-moh/cascade-planning` with the access guard for roles `district-health-officer`, `moh`.
...
11. Add ARB keys under `08_district_moh.cascade_planning` only — no hard-coded user strings.
