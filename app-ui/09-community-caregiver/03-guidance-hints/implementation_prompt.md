# Implementation prompt — `09-community-caregiver/03-guidance-hints`
...
| Screen slug | `03-guidance-hints` |
| Chronology | `S-063` |
| Slice | `VS-09` |
| Phase | `mvp` |
| Deferred | `false` |
| Chronology status | `not-started` |
| Route | `/09-community-caregiver/03-guidance-hints` |
| Parent route | `/09-community-caregiver/03-guidance-hints` |
...
| Localization prefix | `09_community_caregiver.03_guidance_hints` |
...
Folder: `app-ui/09-community-caregiver/03-guidance-hints/`
...
| Page | `frontend/lib/features/community_caregiver/presentation/pages/03_guidance_hints_page.dart` |
...
| Router entry | `frontend/lib/app/router/` (route must equal `/09-community-caregiver/03-guidance-hints`) |
...
8. Register route `/09-community-caregiver/03-guidance-hints` with the access guard for roles `caregiver`, `community-member`.
...
11. Add ARB keys under `09_community_caregiver.03_guidance_hints` only — no hard-coded user strings.
