# Implementation prompt — `09-community-caregiver/guidance-hints`
...
| Route | `/09-community-caregiver/guidance-hints` |
| Parent route | `/09-community-caregiver/guidance-hints` |
...
| Localization prefix | `09_community_caregiver.guidance_hints` |
...
Folder: `app-ui/09-community-caregiver/guidance-hints/`
...
| Router entry | `frontend/lib/app/router/` (route must equal `/09-community-caregiver/guidance-hints`) |
...
8. Register route `/09-community-caregiver/guidance-hints` with the access guard for roles `caregiver`, `community-member`.
...
11. Add ARB keys under `09_community_caregiver.guidance_hints` only — no hard-coded user strings.
