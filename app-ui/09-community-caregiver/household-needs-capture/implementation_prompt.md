# Implementation prompt — `09-community-caregiver/household-needs-capture`
...
| Route | `/09-community-caregiver/household-needs-capture` |
| Parent route | `/09-community-caregiver/household-needs-capture` |
| Layout | `form-capture` |
...
| Localization prefix | `09_community_caregiver.household_needs_capture` |
...
Folder: `app-ui/09-community-caregiver/household-needs-capture/`
...
- `app-ui/09-community-caregiver/README.md`
...
| Router entry | `frontend/lib/app/router/` (route must equal `/09-community-caregiver/household-needs-capture`) |
...
7. Map navigation:
   - Tabs: Home → `/09-community-caregiver/my-household`; Report → `/09-community-caregiver/self-report`; Guidance → `/09-community-caregiver/guidance-hints`; More → `/09-community-caregiver/household-needs-capture`
   - Primary action: Submit needs signal → `/09-community-caregiver/household-needs-capture?state=success`
   - Access denied → `/00-shared/access-denied`
   - Not found → `/00-shared/not-found`

### Phase 2 — Flutter UI on fixtures (maximum reuse)

8. Register route `/09-community-caregiver/household-needs-capture` with the access guard for roles `caregiver`, `community-member`.
...
11. Add ARB keys under `09_community_caregiver.household_needs_capture` only — no hard-coded user strings.
