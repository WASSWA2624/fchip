...
| --- | --- | --- | --- |
| Ingest & sync (`ingest-pipeline`) | [mobile](ingest-pipeline/mobile.png) | [tablet](ingest-pipeline/tablet.png) | [desktop](ingest-pipeline/desktop.png) |
| AI / predictive (`ai-risk-scores`) | [mobile](ai-risk-scores/mobile.png) | [tablet](ai-risk-scores/tablet.png) | [desktop](ai-risk-scores/desktop.png) |
