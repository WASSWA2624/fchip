# Implementation prompt — `09-intelligence/gis-explorer`
...
| Screen slug | `gis-explorer` |
| Chronology | `S-052` |
| Slice | `VS-09` |
| Phase | `mvp` |
| Deferred | `false` |
| Chronology status | `not-started` |
| Route | `/09-intelligence/gis-explorer` |
| Parent route | `/09-intelligence/gis-explorer` |
| Layout | `map-explorer` |
...
| Localization prefix | `09_intelligence.gis_explorer` |
...
Folder: `app-ui/09-intelligence/gis-explorer/`
...
| Page | `frontend/lib/features/intelligence/presentation/pages/gis_explorer_page.dart` |
...
| Router entry | `frontend/lib/app/router/` (route must equal `/09-intelligence/gis-explorer`) |
...
8. Register route `/09-intelligence/gis-explorer` with the access guard for roles `intelligence-analyst`, `platform-operator`.
...
11. Add ARB keys under `09_intelligence.gis_explorer` only — no hard-coded user strings.
