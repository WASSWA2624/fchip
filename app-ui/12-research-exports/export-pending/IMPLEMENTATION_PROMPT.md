# Implementation prompt — `12-research-exports/export-pending`
...
| Route | `/12-research-exports/export-pending` |
| Parent route | `/12-research-exports/evidence-catalog` |
...
| Localization prefix | `12_research_exports.export_pending` |
...
Folder: `app-ui/12-research-exports/export-pending/`
...
- `app-ui/12-research-exports/README.md`
...
| Router entry | `frontend/lib/app/router/` (route must equal `/12-research-exports/export-pending`) |
...
7. Map navigation:
   - Tabs: Monitor → `/11-ngo-partner/programme-monitoring`; Evidence → `/11-ngo-partner/impact-evidence`; Training → `/11-ngo-partner/training-skills-analytics`; More → `/12-research-exports/evidence-catalog`
   - Primary action: Return to evidence catalog → `/12-research-exports/evidence-catalog`
   - Access denied → `/00-shared/access-denied`
   - Not found → `/00-shared/not-found`

### Phase 2 — Flutter UI on fixtures (maximum reuse)

8. Register route `/12-research-exports/export-pending` with the access guard for roles `ngo-partner`, `researcher`.
...
11. Add ARB keys under `12_research_exports.export_pending` only — no hard-coded user strings.
