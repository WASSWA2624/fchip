# Implementation prompt — `12-research-exports/research-contribution-upload`
...
| Route | `/12-research-exports/research-contribution-upload` |
...
| Localization prefix | `12_research_exports.research_contribution_upload` |
...
Folder: `app-ui/12-research-exports/research-contribution-upload/`
...
| Router entry | `frontend/lib/app/router/` (route must equal `/12-research-exports/research-contribution-upload`) |
...
7. Map navigation:
   ...
   - Primary action: Contribute dataset → `/12-research-exports/research-contribution-upload?state=success`
   - Access denied → `/00-shared/access-denied`
   - Not found → `/00-shared/not-found`

### Phase 2 — Flutter UI on fixtures (maximum reuse)

8. Register route `/12-research-exports/research-contribution-upload` with the access guard for roles `ngo-partner`, `researcher`.
...
11. Add ARB keys under `12_research_exports.research_contribution_upload` only — no hard-coded user strings.
