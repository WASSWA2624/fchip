# Implementation prompt — `13-chis-livelihoods/02-contributions`
...
Folder: `app-ui/13-chis-livelihoods/02-contributions/`
...
| Page | `frontend/lib/features/chis_livelihoods/presentation/pages/02_contributions_page.dart` |
...
| Router entry | `frontend/lib/app/router/` (route must equal `/13-chis-livelihoods/02-contributions`) |
...
8. Register route `/13-chis-livelihoods/02-contributions` with the access guard for roles `ngo-partner`, `researcher`.
...
11. Add ARB keys under `13_chis_livelihoods.02_contributions` only — no hard-coded user strings.
