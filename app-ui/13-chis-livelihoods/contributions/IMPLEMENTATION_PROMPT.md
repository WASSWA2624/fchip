# Implementation prompt — `13-chis-livelihoods/contributions`
...
| Route | `/13-chis-livelihoods/contributions` |
...
| Localization prefix | `13_chis_livelihoods.contributions` |
...
Folder: `app-ui/13-chis-livelihoods/contributions/`
...
| Router entry | `frontend/lib/app/router/` (route must equal `/13-chis-livelihoods/contributions`) |
...
8. Register route `/13-chis-livelihoods/contributions` with the access guard for roles `ngo-partner`, `researcher`.
...
11. Add ARB keys under `13_chis_livelihoods.contributions` only — no hard-coded user strings.
