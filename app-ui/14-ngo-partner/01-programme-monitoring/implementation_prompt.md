# Implementation prompt — `14-ngo-partner/01-programme-monitoring`
...
| Screen slug | `01-programme-monitoring` |
| Chronology | `S-082` |
| Slice | `VS-14` |
| Phase | `phase-2` |
| Deferred | `false` |
| Chronology status | `not-started` |
| Route | `/14-ngo-partner/01-programme-monitoring` |
...
| Localization prefix | `14_ngo_partner.01_programme_monitoring` |
...
Folder: `app-ui/14-ngo-partner/01-programme-monitoring/`
...
| Page | `frontend/lib/features/ngo_partner/presentation/pages/01_programme_monitoring_page.dart` |
...
| Router entry | `frontend/lib/app/router/` (route must equal `/14-ngo-partner/01-programme-monitoring`) |
...
8. Register route `/14-ngo-partner/01-programme-monitoring` with the access guard for roles `ngo-partner`, `researcher`.
...
11. Add ARB keys under `14_ngo_partner.01_programme_monitoring` only — no hard-coded user strings.
