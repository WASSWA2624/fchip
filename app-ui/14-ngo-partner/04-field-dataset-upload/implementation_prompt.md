# Implementation prompt — `14-ngo-partner/04-field-dataset-upload`
...
| Screen slug | `04-field-dataset-upload` |
| Chronology | `S-085` |
| Slice | `VS-14` |
| Phase | `phase-2` |
| Deferred | `false` |
...
Folder: `app-ui/14-ngo-partner/04-field-dataset-upload/`
...
| Page | `frontend/lib/features/ngo_partner/presentation/pages/04_field_dataset_upload_page.dart` |
