# Implementation prompt — `14-ngo-partner/programme-monitoring`
...
| Route | `/14-ngo-partner/programme-monitoring` |
...
| Localization prefix | `14_ngo_partner.programme_monitoring` |
...
Folder: `app-ui/14-ngo-partner/programme-monitoring/`
...
| Router entry | `frontend/lib/app/router/` (route must equal `/14-ngo-partner/programme-monitoring`) |
...
8. Register route `/14-ngo-partner/programme-monitoring` with the access guard for roles `ngo-partner`, `researcher`.
...
11. Add ARB keys under `14_ngo_partner.programme_monitoring` only — no hard-coded user strings.
