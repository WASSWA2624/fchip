# Implementation prompt — `17-labs-poc/03-batch-results-upload`
...
| Kind | Screen (`form`) |
| Module | `17-labs-poc` |
| Screen slug | `03-batch-results-upload` |
| Chronology | `S-099` |
| Slice | `VS-17` |
| Phase | `phase-2` |
| Deferred | `false` |
...
Folder: `app-ui/17-labs-poc/03-batch-results-upload/`
...
| Page | `frontend/lib/features/labs_poc/presentation/pages/03_batch_results_upload_page.dart` |
