# Implementation prompt — `18-corporate-wellness/corporate-home`
...
| Route | `/18-corporate-wellness/corporate-home` |
| Parent route | `/18-corporate-wellness/corporate-home` |
| Layout | `feeder-home` |
...
| Localization prefix | `18_corporate_wellness.corporate_home` |
...
Folder: `app-ui/18-corporate-wellness/corporate-home/`
...
| Router entry | `frontend/lib/app/router/` (route must equal `/18-corporate-wellness/corporate-home`) |
...
7. Map navigation:
   ...
   - Primary action: Start camp entry → `/18-corporate-wellness/corporate-home`
   - Access denied → `/00-shared/access-denied`
   - Not found → `/00-shared/not-found`

### Phase 2 — Flutter UI on fixtures (maximum reuse)

8. Register route `/18-corporate-wellness/corporate-home` with the access guard for roles `wellness-programme-worker`.
...
11. Add ARB keys under `18_corporate_wellness.corporate_home` only — no hard-coded user strings.
