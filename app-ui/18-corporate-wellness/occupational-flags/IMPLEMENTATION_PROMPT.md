# Implementation prompt — `18-corporate-wellness/occupational-flags`
...
| Route | `/18-corporate-wellness/occupational-flags` |
| Parent route | `/18-corporate-wellness/occupational-flags` |
...
| Localization prefix | `18_corporate_wellness.occupational_flags` |
...
Folder: `app-ui/18-corporate-wellness/occupational-flags/`
...
| Router entry | `frontend/lib/app/router/` (route must equal `/18-corporate-wellness/occupational-flags`) |
...
8. Register route `/18-corporate-wellness/occupational-flags` with the access guard for roles `wellness-programme-worker`.
...
11. Add ARB keys under `18_corporate_wellness.occupational_flags` only — no hard-coded user strings.
