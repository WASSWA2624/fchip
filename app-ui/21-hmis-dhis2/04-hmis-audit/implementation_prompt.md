# Implementation prompt — `21-hmis-dhis2/04-hmis-audit`
...
| Screen slug | `04-hmis-audit` |
| Chronology | `S-117` |
| Slice | `VS-21` |
| Phase | `phase-2` |
| Deferred | `false` |
| Chronology status | `not-started` |
| Route | `/21-hmis-dhis2/04-hmis-audit` |
| Parent route | `/21-hmis-dhis2/04-hmis-audit` |
...
| Localization prefix | `21_hmis_dhis2.04_hmis_audit` |
...
Folder: `app-ui/21-hmis-dhis2/04-hmis-audit/`
...
| Page | `frontend/lib/features/hmis_dhis2/presentation/pages/04_hmis_audit_page.dart` |
...
| Router entry | `frontend/lib/app/router/` (route must equal `/21-hmis-dhis2/04-hmis-audit`) |
...
8. Register route `/21-hmis-dhis2/04-hmis-audit` with the access guard for roles `hmis-operator`.
...
11. Add ARB keys under `21_hmis_dhis2.04_hmis_audit` only — no hard-coded user strings.
