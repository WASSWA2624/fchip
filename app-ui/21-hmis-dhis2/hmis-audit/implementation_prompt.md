# Implementation prompt — `21-hmis-dhis2/hmis-audit`
...
| Route | `/21-hmis-dhis2/hmis-audit` |
| Parent route | `/21-hmis-dhis2/hmis-audit` |
...
| Localization prefix | `21_hmis_dhis2.hmis_audit` |
...
Folder: `app-ui/21-hmis-dhis2/hmis-audit/`
...
| Router entry | `frontend/lib/app/router/` (route must equal `/21-hmis-dhis2/hmis-audit`) |
...
8. Register route `/21-hmis-dhis2/hmis-audit` with the access guard for roles `hmis-operator`.
...
11. Add ARB keys under `21_hmis_dhis2.hmis_audit` only — no hard-coded user strings.
