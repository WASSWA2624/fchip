# Implementation prompt — `23-research-exports/01-evidence-catalog`
...
| Screen slug | `01-evidence-catalog` |
| Chronology | `S-124` |
| Slice | `VS-23` |
| Phase | `phase-4` |
| Deferred | `false` |
| Chronology status | `not-started` |
| Route | `/23-research-exports/01-evidence-catalog` |
...
| Localization prefix | `23_research_exports.01_evidence_catalog` |
...
Folder: `app-ui/23-research-exports/01-evidence-catalog/`
...
| Page | `frontend/lib/features/research_exports/presentation/pages/01_evidence_catalog_page.dart` |
...
| Router entry | `frontend/lib/app/router/` (route must equal `/23-research-exports/01-evidence-catalog`) |
...
8. Register route `/23-research-exports/01-evidence-catalog` with the access guard for roles `ngo-partner`, `researcher`.
...
11. Add ARB keys under `23_research_exports.01_evidence_catalog` only — no hard-coded user strings.
