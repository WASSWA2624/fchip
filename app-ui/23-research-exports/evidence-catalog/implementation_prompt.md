# Implementation prompt — `23-research-exports/evidence-catalog`
...
| Route | `/23-research-exports/evidence-catalog` |
...
| Localization prefix | `23_research_exports.evidence_catalog` |
...
Folder: `app-ui/23-research-exports/evidence-catalog/`
...
| Router entry | `frontend/lib/app/router/` (route must equal `/23-research-exports/evidence-catalog`) |
...
8. Register route `/23-research-exports/evidence-catalog` with the access guard for roles `ngo-partner`, `researcher`.
...
11. Add ARB keys under `23_research_exports.evidence_catalog` only — no hard-coded user strings.
