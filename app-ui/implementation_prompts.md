...
- **component** [`02-buttons/02-text-link`](00-shared/components/02-buttons/02-text-link/implementation_prompt.md)
- **component** [`02-buttons/03-secondary-cta`](00-shared/components/02-buttons/03-secondary-cta/implementation_prompt.md)
- **component** [`02-buttons/04-danger-cta`](00-shared/components/02-buttons/04-danger-cta/implementation_prompt.md)
- **component** [`03-forms/01-labeled-field`](00-shared/components/03-forms/01-labeled-field/implementation_prompt.md)
- **component** [`03-forms/02-form-stack`](00-shared/components/03-forms/02-form-stack/implementation_prompt.md)
- **component** [`03-forms/03-consent-toggle`](00-shared/components/03-forms/03-consent-toggle/implementation_prompt.md)
- **component** [`03-forms/04-select-field`](00-shared/components/03-forms/04-select-field/implementation_prompt.md)
- **component** [`03-forms/05-file-upload-field`](00-shared/components/03-forms/05-file-upload-field/implementation_prompt.md)
- **component** [`04-navigation/01-role-picker-row`](00-shared/components/04-navigation/01-role-picker-row/implementation_prompt.md)
- **component** [`04-navigation/02-section-header`](00-shared/components/04-navigation/02-section-header/implementation_prompt.md)
- **component** [`04-navigation/03-top-app-bar`](00-shared/components/04-navigation/03-top-app-bar/implementation_prompt.md)
- **component** [`04-navigation/04-bottom-nav-field`](00-shared/components/04-navigation/04-bottom-nav-field/implementation_prompt.md)
- **component** [`04-navigation/05-side-nav-desktop`](00-shared/components/04-navigation/05-side-nav-desktop/implementation_prompt.md)
- **component** [`04-navigation/06-bottom-nav-intel`](00-shared/components/04-navigation/06-bottom-nav-intel/implementation_prompt.md)
- **component** [`04-navigation/07-bottom-nav-caregiver`](00-shared/components/04-navigation/07-bottom-nav-caregiver/implementation_prompt.md)
- **component** [`04-navigation/08-bottom-nav-feeder`](00-shared/components/04-navigation/08-bottom-nav-feeder/implementation_prompt.md)
- **component** [`04-navigation/09-bottom-nav-insurance`](00-shared/components/04-navigation/09-bottom-nav-insurance/implementation_prompt.md)
- **component** [`05-chips/01-status-chip`](00-shared/components/05-chips/01-status-chip/implementation_prompt.md)
- **component** [`05-chips/02-risk-chip`](00-shared/components/05-chips/02-risk-chip/implementation_prompt.md)
- **component** [`05-chips/03-filter-chip-row`](00-shared/components/05-chips/03-filter-chip-row/implementation_prompt.md)
- **component** [`05-chips/04-offline-ready-chip`](00-shared/components/05-chips/04-offline-ready-chip/implementation_prompt.md)
- **component** [`06-cards/01-list-row-card`](00-shared/components/06-cards/01-list-row-card/implementation_prompt.md)
- **component** [`06-cards/02-stat-card`](00-shared/components/06-cards/02-stat-card/implementation_prompt.md)
- **component** [`06-cards/03-stat-card-row`](00-shared/components/06-cards/03-stat-card-row/implementation_prompt.md)
- **component** [`06-cards/04-note-banner`](00-shared/components/06-cards/04-note-banner/implementation_prompt.md)
- **component** [`06-cards/05-explainability-block`](00-shared/components/06-cards/05-explainability-block/implementation_prompt.md)
- **component** [`06-cards/06-warn-banner`](00-shared/components/06-cards/06-warn-banner/implementation_prompt.md)
- **component** [`07-feedback/01-empty-state`](00-shared/components/07-feedback/01-empty-state/implementation_prompt.md)
- **component** [`07-feedback/02-loading-skeleton`](00-shared/components/07-feedback/02-loading-skeleton/implementation_prompt.md)
- **component** [`07-feedback/03-success-toast`](00-shared/components/07-feedback/03-success-toast/implementation_prompt.md)
- **component** [`07-feedback/04-sync-status-strip`](00-shared/components/07-feedback/04-sync-status-strip/implementation_prompt.md)
- **component** [`07-feedback/05-error-inline`](00-shared/components/07-feedback/05-error-inline/implementation_prompt.md)
- **component** [`08-data-display/01-metrics-spark-row`](00-shared/components/08-data-display/01-metrics-spark-row/implementation_prompt.md)
- **component** [`08-data-display/02-timeline-step`](00-shared/components/08-data-display/02-timeline-step/implementation_prompt.md)
...
- **component** [`08-data-display/04-hotspot-map`](00-shared/components/08-data-display/04-hotspot-map/implementation_prompt.md)
- **component** [`08-data-display/05-queue-item`](00-shared/components/08-data-display/05-queue-item/implementation_prompt.md)
...
- **layout** [`03-field-mobile-shell`](00-shared/layouts/03-field-mobile-shell/implementation_prompt.md)
- **layout** [`04-field-tablet-shell`](00-shared/layouts/04-field-tablet-shell/implementation_prompt.md)
- **layout** [`05-desktop-sidebar-shell`](00-shared/layouts/05-desktop-sidebar-shell/implementation_prompt.md)
- **layout** [`06-empty-state-shell`](00-shared/layouts/06-empty-state-shell/implementation_prompt.md)
- **layout** [`07-settings-admin`](00-shared/layouts/07-settings-admin/implementation_prompt.md)
- **layout** [`08-form-capture`](00-shared/layouts/08-form-capture/implementation_prompt.md)
- **layout** [`09-detail-action`](00-shared/layouts/09-detail-action/implementation_prompt.md)
- **layout** [`10-dashboard-metrics`](00-shared/layouts/10-dashboard-metrics/implementation_prompt.md)
- **layout** [`11-connector-status`](00-shared/layouts/11-connector-status/implementation_prompt.md)
- **layout** [`12-map-explorer`](00-shared/layouts/12-map-explorer/implementation_prompt.md)
- **layout** [`13-queue-desk`](00-shared/layouts/13-queue-desk/implementation_prompt.md)
- **layout** [`14-feeder-home`](00-shared/layouts/14-feeder-home/implementation_prompt.md)
- **layout** [`15-upload-batch`](00-shared/layouts/15-upload-batch/implementation_prompt.md)
- **layout** [`16-dual-pane-desktop`](00-shared/layouts/16-dual-pane-desktop/implementation_prompt.md)
