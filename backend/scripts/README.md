...
The FCHIP demo environment now uses a curated reset, seed, and verify flow aligned to `write-up.md` and `subscription-plan.md`.
...
- Role-based demo users such as `tenant.admin@fchip.com`, `doctor@fchip.com`, `nurse@fchip.com`, `radiology@fchip.com`, and `biomed@fchip.com`
- Default password for every seeded account: `Fchip@2624.`
...
| Email                       | Role           | Tenant                    |
| --------------------------- | -------------- | ------------------------- |
| `super.admin@fchip.com`    | SUPER_ADMIN    | DemoCare General Hospital |
| `tenant.admin@fchip.com`   | TENANT_ADMIN   | DemoCare General Hospital |
| `facility.admin@fchip.com` | FACILITY_ADMIN | DemoCare General Hospital |
| `doctor@fchip.com`         | DOCTOR         | DemoCare General Hospital |
| `nurse@fchip.com`          | NURSE          | DemoCare General Hospital |
| `lab@fchip.com`            | LAB_TECH       | DemoCare General Hospital |
| `radiology@fchip.com`      | RADIOLOGY_TECH | DemoCare General Hospital |
| `pharmacy@fchip.com`       | PHARMACIST     | DemoCare General Hospital |
