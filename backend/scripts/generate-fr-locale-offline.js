...
const EXACT_PHRASES = new Map([
  ['FairBanks Community Health Intelligence Platform', 'FCHIP Système de gestion hospitalière'],
  ['FCHIP', 'FCHIP'],
  ['Settings', 'Paramètres'],
  ['Language', 'Langue'],
  ['English', 'Anglais'],
  ...
  ['Scheduling & roster', 'Planification et roulement'],
  ['Approvals & alerts', 'Approbations et alertes'],
  ['Activity & audit', 'Activité et audit'],
  ['Workspace', 'Espace de travail'],
  ['Facilities', 'Établissements'],
  ['Full screen', 'Plein écran'],
  ['Exit full screen', 'Quitter le plein écran'],
  ['Request maintenance', 'Demander une maintenance'],
  ['Emergency case', 'Cas d\'urgence'],
  ['ICU stay', 'Séjour en soins intensifs'],
  ['Loading ICU board', 'Chargement du tableau de soins intensifs'],
  ['Saving', 'Enregistrement'],
  ['Patient board', 'Tableau des patients'],
  ['Bed board', 'Tableau des lits'],
  ['All ICU', 'Tous les soins intensifs'],
  ['Active ICU', 'Soins intensifs actifs'],
  ['Critical alerts', 'Alertes critiques'],
  ['Transfers', 'Transferts'],
  ['Discharge ready', 'Prêt pour la sortie'],
  ['Ended stays', 'Séjours terminés'],
  ['ICU board', 'Tableau des soins intensifs'],
  ['Board scope', 'Portée du tableau'],
  ['Alert', 'Alerte'],
  ['Transfer', 'Transfert'],
  ['ICU start', 'Début des soins intensifs'],
  ['Source', 'Source'],
  ['No ICU patients', 'Aucun patient en soins intensifs'],
  ['No alert', 'Aucune alerte'],
  ['No ICU stay selected', 'Aucun séjour en soins intensifs sélectionné'],
  ['Loading ICU stay', 'Chargement du séjour en soins intensifs'],
  ['Admission', 'Admission'],
  ['Location', 'Emplacement'],
  ['Facility', 'Établissement'],
  ['Admitted', 'Admis'],
  ['ICU stay started', 'Séjour en soins intensifs commencé'],
  ['Observations', 'Observations'],
  ['No ICU observations recorded', 'Aucune observation en soins intensifs enregistrée'],
  ['Vitals trend', 'Tendance des signes vitaux'],
  ['Round note', 'Note de ronde'],
  ['Nursing note', 'Note infirmière'],
  ['Medication task', 'Tâche médicamenteuse'],
  ['Dose', 'Dose'],
  ['Active ICU stay', 'Séjour actif en soins intensifs'],
  ['Previous ICU stay', 'Séjour précédent en soins intensifs'],
  ['Start ICU stay', 'Commencer un séjour en soins intensifs'],
  ['Observation', 'Observation'],
  ['Vitals', 'Signes vitaux'],
  ['Critical alert', 'Alerte critique'],
  ['Acknowledge alert', 'Accuser réception de l\'alerte'],
  ['ICU round', 'Ronde de soins intensifs'],
  ['Order imaging', 'Prescrire une imagerie'],
  ['Prescribe', 'Prescrire'],
  ['Discharge readiness', 'Préparation à la sortie'],
  ['Open in IPD', 'Ouvrir en hospitalisation'],
  ['Open billing', 'Ouvrir la facturation'],
  ['Billing deferred', 'Facturation différée'],
  ['End ICU stay', 'Terminer le séjour en soins intensifs'],
  ['Record ICU observation', 'Enregistrer une observation en soins intensifs'],
  ['Record', 'Enregistrer'],
  ['Severity', 'Gravité'],
  ['Alert message', 'Message d\'alerte'],
  ['Add alert', 'Ajouter une alerte'],
  ['Add ICU round note', 'Ajouter une note de ronde en soins intensifs'],
  ['Add note', 'Ajouter une note'],
  ['Request', 'Demande'],
  ['Readiness note', 'Note de préparation'],
  ['Mark ready', 'Marquer comme prêt'],
  ['Start stay', 'Commencer le séjour'],
  ['Approve', 'Approuver'],
  ['Start', 'Commencer'],
  ['End ICU stay?', 'Terminer le séjour en soins intensifs ?'],
  ['ICU changes saved.', 'Modifications des soins intensifs enregistrées.'],
  ['Patient', 'Patient'],
  ['Vacant', 'Vacant'],
  ['Patients', 'Patients'],
  ['Reference', 'Référence'],
  ['Payer', 'Payeur'],
  ['Payment', 'Paiement'],
  ['Request void', 'Demander l\'annulation'],
  ...
  ['Attach proof', 'Joindre une preuve'],
  ['Remove attachment', 'Supprimer la pièce jointe'],
  ['Platform billing contact', 'Contact de facturation de la plateforme'],
  ['Phone', 'Téléphone'],
  ['Submit renewal', 'Soumettre le renouvellement'],
  ['Mobile money number', 'Numéro de mobile money'],
  ['Bank', 'Banque'],
  ['Set FCHIP preferences.', 'Définir les préférences FCHIP.'],
...
const offlineTranslate = (text) => {
  ...
  for (const [phrase, translation] of EXACT_PHRASES) {
    if (phrase.toLowerCase() === trimmed.toLowerCase()) {
      return translation;
    }
  }
