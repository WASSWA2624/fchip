...
const buildEnv = () => {
  ...
  const APP_DISPLAY_NAME =
    String(process.env.APP_DISPLAY_NAME || 'FairBanks Community Health Intelligence Platform').trim() ||
    'FairBanks Community Health Intelligence Platform';
  const APP_SHORT_NAME = String(process.env.APP_SHORT_NAME || 'FCHIP').trim() || 'FCHIP';
  ...
  const PLATFORM_BANK_ACCOUNT_NAME = process.env.PLATFORM_BANK_ACCOUNT_NAME || null;
  const PLATFORM_BANK_NAME = process.env.PLATFORM_BANK_NAME || null;
  const PLATFORM_BANK_BRANCH = process.env.PLATFORM_BANK_BRANCH || null;
  const PLATFORM_BANK_ACCOUNT_NUMBER = process.env.PLATFORM_BANK_ACCOUNT_NUMBER || null;
  const PLATFORM_BANK_SWIFT_CODE = process.env.PLATFORM_BANK_SWIFT_CODE || null;
  const PLATFORM_BANK_IBAN = process.env.PLATFORM_BANK_IBAN || null;
  ...
  const OTEL_SERVICE_NAME =
    String(process.env.OTEL_SERVICE_NAME || 'fchip-backend').trim() || 'fchip-backend';
