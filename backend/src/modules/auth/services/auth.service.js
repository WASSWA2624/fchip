...
const APP_DISPLAY_NAME =
  String(env.APP_DISPLAY_NAME || 'FairBanks Community Health Intelligence Platform').trim() ||
  'FairBanks Community Health Intelligence Platform';
const VERIFICATION_EMAIL_APP_NAME = 'FCHIP';
const EMAIL_LOGO_CID = 'fchip-app-logo';
const EMAIL_LOGO_PATHS = [
  ...
  path.resolve(__dirname, '../../../../../fchip-frontend/public/logo.png'),
  path.resolve(__dirname, '../../../../../fchip-frontend/assets/logo.png'),
