 ...
 *
 * The catalog intentionally uses local FCHIP catalog codes instead of claiming
...
const explicitProcedureTerms = [
  ['Wound cleaning and dressing', 'FCHIP-PROC-000001', 'Wound care', 'minor surgery wound dressing'],
  ['Simple wound suturing', 'FCHIP-PROC-000002', 'Minor surgery', 'laceration repair stitches'],
  ['Complex wound suturing', 'FCHIP-PROC-000003', 'Minor surgery', 'laceration repair layered closure'],
  ['Incision and drainage of skin abscess', 'FCHIP-PROC-000004', 'Minor surgery', 'abscess drainage I and D'],
  ['Incision and drainage of breast abscess', 'FCHIP-PROC-000005', 'Minor surgery', 'breast abscess drainage'],
  ['Wound debridement', 'FCHIP-PROC-000006', 'Wound care', 'dead tissue removal'],
  ['Burn wound dressing', 'FCHIP-PROC-000007', 'Wound care', 'burn care dressing'],
  ['Foreign body removal from skin', 'FCHIP-PROC-000008', 'Minor surgery', 'splinter glass metal removal'],
  ['Foreign body removal from ear', 'FCHIP-PROC-000009', 'ENT', 'ear foreign body removal'],
  ['Foreign body removal from nose', 'FCHIP-PROC-000010', 'ENT', 'nasal foreign body removal'],
  ['Skin lesion excision', 'FCHIP-PROC-000011', 'Dermatology', 'minor surgery skin lesion removal'],
  ['Lipoma excision', 'FCHIP-PROC-000012', 'Dermatology', 'minor surgery lipoma removal'],
  ['Sebaceous cyst excision', 'FCHIP-PROC-000013', 'Dermatology', 'minor surgery cyst removal'],
  ['Keloid excision', 'FCHIP-PROC-000014', 'Dermatology', 'scar keloid removal'],
  ['Skin biopsy', 'FCHIP-PROC-000015', 'Dermatology', 'punch shave biopsy'],
  ['Punch biopsy', 'FCHIP-PROC-000016', 'Dermatology', 'skin punch biopsy'],
  ['Shave biopsy', 'FCHIP-PROC-000017', 'Dermatology', 'skin shave biopsy'],
  ['Nail avulsion', 'FCHIP-PROC-000018', 'Minor surgery', 'ingrown toenail nail removal'],
  ['Partial nail avulsion', 'FCHIP-PROC-000019', 'Minor surgery', 'ingrown toenail partial nail removal'],
  ['Toe nail wedge resection', 'FCHIP-PROC-000020', 'Minor surgery', 'ingrown toenail wedge resection'],
  ['Circumcision', 'FCHIP-PROC-000021', 'Minor surgery', 'male circumcision'],
  ['Manual vacuum aspiration', 'FCHIP-PROC-000022', 'Obstetrics and gynecology', 'MVA uterine evacuation'],
  ['Intrauterine device insertion', 'FCHIP-PROC-000023', 'Obstetrics and gynecology', 'IUD IUCD insertion'],
  ['Intrauterine device removal', 'FCHIP-PROC-000024', 'Obstetrics and gynecology', 'IUD IUCD removal'],
  ['Implant insertion', 'FCHIP-PROC-000025', 'Family planning', 'contraceptive implant insertion'],
  ['Implant removal', 'FCHIP-PROC-000026', 'Family planning', 'contraceptive implant removal'],
  ['Pap smear collection', 'FCHIP-PROC-000027', 'Obstetrics and gynecology', 'cervical smear screening'],
  ['Visual inspection with acetic acid', 'FCHIP-PROC-000028', 'Obstetrics and gynecology', 'VIA cervical screening'],
  ['Cervical cryotherapy', 'FCHIP-PROC-000029', 'Obstetrics and gynecology', 'cervical lesion treatment'],
  ['Endometrial biopsy', 'FCHIP-PROC-000030', 'Obstetrics and gynecology', 'uterine biopsy'],
  ['Urethral catheterization', 'FCHIP-PROC-000031', 'Urology', 'urinary catheter insertion'],
  ['Suprapubic catheter change', 'FCHIP-PROC-000032', 'Urology', 'catheter replacement'],
  ['Bladder washout', 'FCHIP-PROC-000033', 'Urology', 'urinary bladder irrigation'],
  ['Joint aspiration', 'FCHIP-PROC-000034', 'Musculoskeletal', 'arthrocentesis'],
  ['Joint injection', 'FCHIP-PROC-000035', 'Musculoskeletal', 'intra-articular injection'],
  ['Closed fracture reduction', 'FCHIP-PROC-000036', 'Musculoskeletal', 'fracture manipulation'],
  ['Plaster cast application', 'FCHIP-PROC-000037', 'Musculoskeletal', 'cast immobilization'],
  ['Plaster cast removal', 'FCHIP-PROC-000038', 'Musculoskeletal', 'cast removal'],
  ['Splint application', 'FCHIP-PROC-000039', 'Musculoskeletal', 'immobilization splint'],
  ['Lumbar puncture', 'FCHIP-PROC-000040', 'Neurology', 'spinal tap CSF'],
  ['Peripheral intravenous cannulation', 'FCHIP-PROC-000041', 'Vascular access', 'IV cannula insertion'],
  ['Central venous catheter insertion', 'FCHIP-PROC-000042', 'Vascular access', 'central line insertion'],
  ['Nasogastric tube insertion', 'FCHIP-PROC-000043', 'Gastrointestinal', 'NG tube insertion'],
  ['Nasogastric tube removal', 'FCHIP-PROC-000044', 'Gastrointestinal', 'NG tube removal'],
  ['Gastric lavage', 'FCHIP-PROC-000045', 'Gastrointestinal', 'stomach washout'],
  ['Nebulization', 'FCHIP-PROC-000046', 'Respiratory', 'nebulizer treatment'],
  ['Oxygen therapy initiation', 'FCHIP-PROC-000047', 'Respiratory', 'oxygen administration'],
  ['Endotracheal intubation', 'FCHIP-PROC-000048', 'Airway', 'airway intubation'],
  ['Tracheostomy tube change', 'FCHIP-PROC-000049', 'Airway', 'tracheostomy care'],
  ['Chest tube insertion', 'FCHIP-PROC-000050', 'Respiratory', 'tube thoracostomy'],
  ['Pleural aspiration', 'FCHIP-PROC-000051', 'Respiratory', 'thoracentesis'],
  ['Ascitic tap', 'FCHIP-PROC-000052', 'Gastrointestinal', 'paracentesis'],
  ['Dental extraction', 'FCHIP-PROC-000053', 'Dental', 'tooth extraction'],
  ['Dental dressing', 'FCHIP-PROC-000054', 'Dental', 'temporary dental filling dressing'],
  ['Eye foreign body removal', 'FCHIP-PROC-000055', 'Ophthalmology', 'corneal foreign body removal'],
  ['Ear syringing', 'FCHIP-PROC-000056', 'ENT', 'ear wax removal'],
  ['Anterior nasal packing', 'FCHIP-PROC-000057', 'ENT', 'epistaxis nose bleed packing'],
  ['Posterior nasal packing', 'FCHIP-PROC-000058', 'ENT', 'epistaxis nose bleed packing'],
  ['Episiotomy repair', 'FCHIP-PROC-000059', 'Obstetrics and gynecology', 'perineal repair'],
  ['Normal vaginal delivery assistance', 'FCHIP-PROC-000060', 'Obstetrics and gynecology', 'delivery procedure'],
  ['Manual removal of placenta', 'FCHIP-PROC-000061', 'Obstetrics and gynecology', 'retained placenta procedure'],
  ['Dilatation and curettage', 'FCHIP-PROC-000062', 'Obstetrics and gynecology', 'D and C uterine curettage'],
  ['Electrocardiogram recording', 'FCHIP-PROC-000063', 'Cardiology', 'ECG EKG'],
  ['Cardioversion', 'FCHIP-PROC-000064', 'Cardiology', 'electrical cardioversion'],
  ['Defibrillation', 'FCHIP-PROC-000065', 'Emergency', 'cardiac defibrillation'],
];
...
const addTerm = (items, seen, { description, code, category, keywords = '', rank = 0 }) => {
  ...
  seen.add(key);
  items.push({
    code: normalizedCode || `FCHIP-PROC-${String(items.length + 1).padStart(6, '0')}`,
  ...
  procedureGroups.forEach((group, groupIndex) => {
    group.actions.forEach((action) => {
      group.sites.forEach((site) => {
        ...
        const baseCode = `FCHIP-${group.code}-${String(items.length + 1).padStart(5, '0')}`;
        addTerm(items, seen, {
        ...
        group.qualifiers.forEach((qualifier) => {
          ...
          addTerm(items, seen, {
            description,
            code: `FCHIP-${group.code}-${String(items.length + 1).padStart(5, '0')}`,
            category: group.category,
