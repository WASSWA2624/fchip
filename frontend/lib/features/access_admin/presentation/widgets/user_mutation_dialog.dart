...
import 'package:fchip/core/permissions/app_permission_catalog_localizations.dart';
...
import 'package:fchip/shared/layout/app_workspace_mutation_dialog.dart';
          ...
          return StatefulBuilder(
            builder: (BuildContext context, StateSetter setState) {
              ...
              return Column(
                ...
                children: <Widget>[
                  if (mode == UserMutationMode.create) ...<Widget>[
                    AppMessagePanel(
                      icon: Icons.lightbulb_outline,
                      message: l10n.accessAdminCreateUserIntro,
                  ...
                  AppSectionPanel(
                    ...
                    children: <Widget>[
                      ...
                      if (!tenantSelected && showTenantPicker)
                        ...
                        _UserMutationLoadingIndicator(
                          label: l10n.accessAdminCreateUserLoadingFacilities,
                        )
