...
import 'package:fchip/features/discharge/data/dtos/discharge_dtos.dart';
...
final class DischargeRepositoryImpl implements DischargeRepository {
  ...
  Future<_OptionalRelatedRecords> _fetchPharmacyOrders({
    ...
    final Result<List<DischargeRelatedRecord>>
    result = await _apiClient.get<List<DischargeRelatedRecord>>(
      ...
      queryParameters: _withoutEmpty(<String, Object?>{
        ...
        if (encounterId == null || encounterId.isEmpty) 'patient_id': patientId,
        'sort_by': 'ordered_at',
        'order': 'desc',
      }),
