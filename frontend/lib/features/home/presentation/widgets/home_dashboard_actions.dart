...
import 'package:fchip/features/home/domain/entities/home_dashboard_layout.dart';
import 'package:fchip/features/home/presentation/controllers/home_dashboard_mutation.dart';
import 'package:fchip/features/home/presentation/controllers/home_dashboard_optimistic_patch.dart';
import 'package:fchip/features/home/presentation/widgets/home_metric_routes.dart';
...
homeActionLibrary = <String, HomeActionDefinition>{
  ...
  'receive_sample': HomeActionDefinition(
    ...
    route: AppRoutes.lab,
    routeQuery: <String, String>{'scope': 'collection'},
  ...
  'enter_lab_result': HomeActionDefinition(
    ...
    route: AppRoutes.lab,
    routeQuery: <String, String>{'scope': 'results'},
    allowedRoles: <AppRole>[AppRole.labTech],
    requiredPermissions: <AppPermission>[AppPermissions.labWrite],
    requiredModules: <String>['lab'],
  ),
  'flag_critical_lab': HomeActionDefinition(
    ...
    route: AppRoutes.lab,
    routeQuery: <String, String>{'scope': 'critical'},
    allowedRoles: <AppRole>[AppRole.labTech],
    requiredPermissions: <AppPermission>[AppPermissions.labWrite],
    requiredModules: <String>['lab'],
  ),
