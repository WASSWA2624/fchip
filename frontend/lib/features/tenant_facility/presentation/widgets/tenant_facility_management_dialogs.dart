...
import 'package:fchip/core/config/app_config_provider.dart';
...
import 'package:fchip/core/realtime/realtime_events.dart';
import 'package:fchip/core/realtime/realtime_message.dart';
import 'package:fchip/core/utils/app_media_url.dart';
import 'package:fchip/features/access_admin/data/repositories/access_admin_repository_impl.dart';
import 'package:fchip/features/access_admin/domain/entities/access_admin_entities.dart';
import 'package:fchip/features/access_admin/domain/repositories/access_admin_repository.dart';
import 'package:fchip/features/access_admin/presentation/widgets/access_admin_dialogs.dart';
import 'package:fchip/features/home/domain/entities/home_dashboard.dart';
import 'package:fchip/features/home/presentation/controllers/home_controller.dart';
import 'package:fchip/features/home/presentation/controllers/home_dashboard_optimistic_patch.dart';
import 'package:fchip/features/home/presentation/controllers/home_dashboard_sync.dart';
import 'package:fchip/features/tenant_facility/data/repositories/tenant_facility_repository_impl.dart';
import 'package:fchip/features/tenant_facility/domain/entities/tenant_facility_setup.dart';
import 'package:fchip/features/tenant_facility/domain/repositories/tenant_facility_repository.dart';
import 'package:fchip/features/tenant_facility/presentation/controllers/tenant_facility_setup_controller.dart';
...
import 'package:fchip/shared/actions/app_action_dialogs.dart';
...
import 'package:fchip/shared/management/platform_admin_list_config.dart';
import 'package:fchip/shared/management/platform_management_list_sync.dart';
...
Future<bool?> showManageTenantsDialog(BuildContext context, WidgetRef ref) {
  return showAppDialog<bool>(
    context: context,
    builder: (_) => const ManageTenantsPanel(dialogMode: true),
  );
}
...
Future<bool?> showManageFacilitiesDialog(BuildContext context, WidgetRef ref) {
  return showAppDialog<bool>(
    context: context,
    builder: (_) => const ManageFacilitiesPanel(dialogMode: true),
  );
}
...
/// Tenants table/CRUD shared by manage dialog and setup Tenants tab.
  ...
  Future<void> _editTenant() async {
    ...
    setState(() {
      _tenant = savedTenant.copyWith(
        ...
        contactName: savedTenant.contactName ?? _tenant.contactName,
        contactEmail: savedTenant.contactEmail ?? _tenant.contactEmail,
        contactPhone: savedTenant.contactPhone ?? _tenant.contactPhone,
      );
    });
        ...
        child: LayoutBuilder(
          builder: (BuildContext context, BoxConstraints constraints) {
            ...
            final Widget facilitiesPanel = _TenantDetailsFacilitiesPanel(
              ...
              onShowSummary: () => setState(() => _summaryVisible = true),
            ...
            final Widget tenantSummary = _TenantDetailsSummary(
              ...
              onHide: () => setState(() => _summaryVisible = false),
            );
            ...
            if (wide) {
              return Row(
                ...
                children: <Widget>[
                  SizedBox(width: 320, child: tenantSummary),
                  VerticalDivider(
              ...
              children: <Widget>[
                ConstrainedBox(
                  constraints: BoxConstraints(
                    maxHeight: math.max(220, constraints.maxHeight * 0.42),
                  ),
                  child: tenantSummary,
                ),
...
class _TenantDetailsFacilitiesPanel extends StatelessWidget {
  ...
  final ValueChanged<FacilityProfile> onRowSelected;
              ...
              : AppListTable<FacilityProfile>(
                  ...
                  search: AppListTableSearch<FacilityProfile>(
                    ...
                    filterGroups: <AppSearchBarFilterGroup>[
                      AppSearchBarFilterGroup(
                        ...
                        choices: <AppSearchBarFilterChoice>[
                          AppSearchBarFilterChoice(
                            value: _TenantDetailsDialogState._statusActive,
                            label: l10n.tenantFacilityTenantStatusActive,
                            icon: Icons.check_circle_outline,
                          ),
                          AppSearchBarFilterChoice(
                            value: _TenantDetailsDialogState._statusDeleted,
                            label: l10n.tenantFacilityTenantStatusDeleted,
                            icon: Icons.delete_outline,
                          ),
                        ],
                  ...
                  columns: <AppListTableColumn<FacilityProfile>>[
                    AppListTableColumn<FacilityProfile>(
                      ...
                      sortComparator:
                          (FacilityProfile left, FacilityProfile right) => left
                              .name
                              .toLowerCase()
...
/// Facilities table/CRUD shared by manage dialog and setup Facility tab.
