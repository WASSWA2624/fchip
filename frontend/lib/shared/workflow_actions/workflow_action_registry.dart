...
final List<WorkflowActionDefinition> _billingActions =
...
final List<WorkflowActionDefinition> _nursingActions =
    <WorkflowActionDefinition>[
      WorkflowActionDefinition(
        code: 'RECORD_VITALS',
        legacyAliases: const <String>[
...
final List<WorkflowActionDefinition> _clinicalActions =
    <WorkflowActionDefinition>[
      WorkflowActionDefinition(
        code: 'DOCTOR_REVIEW',
        legacyAliases: const <String>[
      ...
      WorkflowActionDefinition(
        ...
        labelBuilder: (AppLocalizations l10n) =>
            l10n.opdMedicinesDispensedAction,
...
final List<WorkflowActionDefinition> _theatreActions =
    <WorkflowActionDefinition>[
      WorkflowActionDefinition(
        ...
        labelBuilder: (AppLocalizations l10n) =>
            l10n.opdTheatreSchedulingAction,
        icon: Icons.event_note_outlined,
        targetModule: 'theater',
        mode: WorkflowActionMode.route,
        accessRequirement: const AccessRequirement(
