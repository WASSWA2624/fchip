...
all seeded accounts: `Fchip@2624.`
...
| ---- | -------- | -------- |
| `smoke_test.dart` | `tenant.admin@fchip.com` | Boot, real login, home (mobile + desktop) |
| `auth_flow_test.dart` | `reception@fchip.com` | Shell redirect, real login/logout |
| `home_navigation_test.dart` | tenant admin / billing / doctor | Dashboard + sidebar navigation |
| `patients_flow_test.dart` | `reception@fchip.com` | Registry list + detail |
| `opd_flow_test.dart` | `doctor@fchip.com` | OPD queue shell |
| `clinical_flow_test.dart` | `doctor@fchip.com` | Clinical workspace shell |
| `lab_flow_test.dart` | `lab@fchip.com` | Laboratory shell |
| `pharmacy_flow_test.dart` | `pharmacy@fchip.com` | Pharmacy shell |
| `billing_flow_test.dart` | `billing@fchip.com` | Billing shell |
| `hr_flow_test.dart` | `hr@fchip.com` | HR staff list |
| `biomedical_flow_test.dart` | `biomed@fchip.com` | Biomedical shell |
| `housekeeping_flow_test.dart` | `housekeeping@fchip.com` | Task queue shell |
| `operations_flow_test.dart` | `operations@fchip.com` | Operations shell |
| `ambulance_flow_test.dart` | `ambulance@fchip.com` | Emergency dispatch shell |
