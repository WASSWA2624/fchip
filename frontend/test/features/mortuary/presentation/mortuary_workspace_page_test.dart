...
void main() {
  ...
  testWidgets('overview toolbar shows disabled receive case and refresh', (
    WidgetTester tester,
  ) async {
    await _pumpMortuaryWorkspace(tester, repository: repository);
    ...
    final Finder receiveCase = find.ancestor(
      of: find.text('Receive case'),
      matching: find.byType(TextButton),
    );
    final TextButton button = tester.widget<TextButton>(receiveCase);
    expect(button.onPressed, isNull);
  });

  testWidgets('intake tab keeps receive case primary', (
    WidgetTester tester,
  ) async {
    await _pumpMortuaryWorkspace(tester, repository: repository);
