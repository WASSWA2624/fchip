...
void main() {
  group('Subscriptions DTOs', () {
    test('parses workspace summary, lookups, items, and overview', () {
      ...
      final SubscriptionsWorkspaceData
      data = SubscriptionsWorkspaceDto.fromResponse(<String, Object?>{
        'data': <String, Object?>{
          'summary': <Object?>[
            <String, Object?>{
          ...
          'overview': <String, Object?>{
            ...
            'recommendations': <Object?>[
              <String, Object?>{'id': 'rec-1', 'title': 'Renew before expiry'},
            ],
      ...
      expect(
        data.overview.notSubscribedTenants.accounts.single.tenantLabel,
        'Clinic B',
      );
      expect(
